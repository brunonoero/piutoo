...
/// <summary>
/// Audit deterministico di PTS_001_NQ_60 + motore interno: forma del segnale,
...
public sealed class PtsEngineAuditTests
{
    ...
    private static PTS_001_NQ_60 CreatePtsWithNeutralPatterns()
    {
        var strategy = new PTS_001_NQ_60();
