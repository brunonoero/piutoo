...
| `origin.json` | chi ha prodotto la cartella (`Internal` / `ExternalBroker`), serie di prezzi, versione del server (`EngineVersion`) e — per l'origine esterna — del cBot (`ClientVersion`), piano, esecuzione, sessione e capitale iniziale |
