...
public sealed class TradingSessionService : ITradingSessionService
{
        ...
        Session session, OrderIntent template, string accountNumber)
    {
        ...
        return new OrderIntent
        {
            ...
            CrossedLevel = template.CrossedLevel,
    ...
    private static StrategyExecutionSnapshot GetExecution(Session session, ITradingStrategy strategy, DateTime time)
    {
        ...
        // La posizione e' quella che il broker ha davvero aperto, anche se la sua deadline cade
        // sulla chiusura di questa barra: e' la parita' con il motore di ricerca, che sull'ultima
        // barra della sessione vede la strategia ancora in posizione e non emette l'ordine per la
        // prima barra della sessione dopo. Presentarla come chiusa (7.4.6, ritirato nella 7.4.7)
        // portava PT2_FDAX_PCH_001_240 lontano dalla scheda. Vedi decisioni.md 2026-09-16.
