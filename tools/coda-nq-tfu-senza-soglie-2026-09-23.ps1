...
# Qui le soglie di profit factor e utile medio vanno a zero nelle fasi, cosi' l'ordinamento puo'
...
& $exe --strategy PT3B_NQ_TFU_001_15 --symbol "@NQ" --timeframe 15 --engine TFU --broker ICS `
    ...
    --min-profit-factor 0 --min-average-trade 0 --objective worst-period --split-pattern-phases `
