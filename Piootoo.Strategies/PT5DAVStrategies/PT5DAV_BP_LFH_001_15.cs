...
/// <summary>
/// <b>PT5DAV_BP_LFH_001_15</b> — LF_HL su BP 15m, codice della ricerca <c>BP-15M-LFHL-c6a4d3</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 420 trade, netto $27,609; broker (27/08/2025 → 09/09/2026)
/// 17 trade, netto $-354. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/BP-15M-LFHL-c6a4d3.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $27,609 su 420 trade · $66 a trade · drawdown $3,967 · netto/DD 6.96 · anni in perdita 1 su 14 · notti a mercato 1.38 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $25,225 su 420 trade, drawdown $3,864.</para>
/// <para><b>Rientro dentro un livello di sessione (fade del falso breakout)</b></para>
/// <para>· livello LONG = L_d1 − 0.15 × ATR50; livello SHORT = H_d1 + 0.15 × ATR50</para>
...
/// <para>· Opera solo fra 09:00 e 11:00, CET: ordini emessi sulle barre che chiudono fra le 09:00 e le 11:00 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_BP_LFH_001_15 : Pt5DavHighLowFaderEngine
{
    public override string Name => "PT5DAV_BP_LFH_001_15";

    public override string Description => "LF_HL BP 15m, ricerca PT5DAV BP-15M-LFHL-c6a4d3";

    public override string Symbol => "@BP";

    public override int TimeframeMinutes => 15;

    public override string ResearchCode => "BP-15M-LFHL-c6a4d3";

    public PT5DAV_BP_LFH_001_15()
    {
        TradingWindow = ResearchWindow(9, 11);  // start_hour 9, end_hour 11, verbatim
        LevelShiftAtr = 0.15m;                  // level_shift_atr
