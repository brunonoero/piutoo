...
/// <summary>
/// <b>PT5DAV_BTC_LFD_004_240</b> — LF su BTC 4h, codice della ricerca <c>BTC-4H-LF-8508b9</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 56 trade, netto $221,800; broker (27/08/2025 → 09/09/2026)
/// 15 trade, netto $-54,387. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/BTC-4H-LF-8508b9.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (26/12/2017 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $221,800 su 56 trade · $3,961 a trade · drawdown $60,922 · netto/DD 3.64 · anni in perdita 1 su 8 · notti a mercato 0.04 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $133,759 su 56 trade, drawdown $29,418.</para>
...
/// <para>· Opera solo fra 00:00 e 00:00, CET: ordini emessi sulle barre che chiudono fra le 00:00 e le 00:00 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_BTC_LFD_004_240 : Pt5DavPivotFaderEngine
{
    public override string Name => "PT5DAV_BTC_LFD_004_240";

    public override string Description => "LF BTC 4h, ricerca PT5DAV BTC-4H-LF-8508b9";

    public override string Symbol => "@BTC";

    public override int TimeframeMinutes => 240;

    public override string ResearchCode => "BTC-4H-LF-8508b9";

    public PT5DAV_BTC_LFD_004_240()
    {
        TradingWindow = ResearchWindow(-1, 0);  // start_hour -1, end_hour 0, verbatim
