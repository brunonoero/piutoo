...
/// <summary>
/// <b>PT5DAV_NQ_RBM_003_240</b> — RBB_M su NQ 4h, codice della ricerca <c>NQ-4H-RBBM-92900f</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 1544 trade, netto $335,237; broker (27/08/2025 → 09/09/2026)
/// 112 trade, netto $-37,290. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/NQ-4H-RBBM-92900f.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $335,237 su 1544 trade · $217 a trade · drawdown $106,269 · netto/DD 3.15 · anni in perdita 2 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $132,728 su 1544 trade, drawdown $50,160.</para>
...
/// </summary>
public sealed class PT5DAV_NQ_RBM_003_240 : Pt5DavBollingerMirroredEngine
{
    public override string Name => "PT5DAV_NQ_RBM_003_240";

    public override string Description => "RBB_M NQ 4h, ricerca PT5DAV NQ-4H-RBBM-92900f";

    public override string Symbol => "@NQ";

    public override int TimeframeMinutes => 240;

    public override string ResearchCode => "NQ-4H-RBBM-92900f";

    public PT5DAV_NQ_RBM_003_240()
    {
