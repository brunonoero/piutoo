...
/// <summary>
/// <b>PT5DAV_KC_LFH_001_60</b> — LF_HL su KC 1h, codice della ricerca <c>KC-1H-LFHL-742947</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 50 trade, netto $33,541; broker (27/08/2025 → 09/09/2026)
/// 4 trade, netto $6,922. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/KC-1H-LFHL-742947.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $33,541 su 50 trade · $671 a trade · drawdown $3,711 · netto/DD 9.04 · anni in perdita 2 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $18,840 su 50 trade, drawdown $2,224.</para>
...
/// <para>· Opera solo fra 15:00 e 16:00, CET: ordini emessi sulle barre che chiudono fra le 15:00 e le 16:00 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_KC_LFH_001_60 : Pt5DavHighLowFaderEngine
{
    public override string Name => "PT5DAV_KC_LFH_001_60";

    public override string Description => "LF_HL KC 1h, ricerca PT5DAV KC-1H-LFHL-742947";

    public override string Symbol => "@KC";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "KC-1H-LFHL-742947";

    public PT5DAV_KC_LFH_001_60()
    {
        TradingWindow = ResearchWindow(15, 16); // start_hour 15, end_hour 16, verbatim
