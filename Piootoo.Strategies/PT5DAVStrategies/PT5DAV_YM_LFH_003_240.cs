...
/// <summary>
/// <b>PT5DAV_YM_LFH_003_240</b> — LF_HL su YM 4h, codice della ricerca <c>YM-4H-LFHL-14aa4a</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 86 trade, netto $143,887; broker (27/08/2025 → 09/09/2026)
/// 4 trade, netto $2,533. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/YM-4H-LFHL-14aa4a.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $143,887 su 86 trade · $1,673 a trade · drawdown $10,936 · netto/DD 13.16 · anni in perdita 3 su 14 · notti a mercato 3.83 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $68,096 su 86 trade, drawdown $7,458.</para>
...
/// </summary>
public sealed class PT5DAV_YM_LFH_003_240 : Pt5DavHighLowFaderEngine
{
    public override string Name => "PT5DAV_YM_LFH_003_240";

    public override string Description => "LF_HL YM 4h, ricerca PT5DAV YM-4H-LFHL-14aa4a";

    public override string Symbol => "@YM";

    public override int TimeframeMinutes => 240;

    public override string ResearchCode => "YM-4H-LFHL-14aa4a";

    public PT5DAV_YM_LFH_003_240()
    {
