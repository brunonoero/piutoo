...
/// <summary>
/// <b>PT5DAV_ES_RHL_001_30</b> — RHL su ES 30m, codice della ricerca <c>ES-30M-RHL-a8743f</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 413 trade, netto $475,122; broker (27/08/2025 → 09/09/2026)
/// 34 trade, netto $51,806. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/ES-30M-RHL-a8743f.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $475,122 su 413 trade · $1,150 a trade · drawdown $47,974 · netto/DD 9.90 · anni in perdita 0 su 14 · notti a mercato 2.22 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $197,059 su 413 trade, drawdown $19,102.</para>
...
/// <para>· Overnight: puo' restare aperta oltre la sessione, al massimo 3 giornate (138 barre); paga lo swap a ogni rollover (17:00 New York)</para>
...
/// </summary>
public sealed class PT5DAV_ES_RHL_001_30 : Pt5DavRhlEngine
{
    public override string Name => "PT5DAV_ES_RHL_001_30";

    public override string Description => "RHL ES 30m, ricerca PT5DAV ES-30M-RHL-a8743f";

    public override string Symbol => "@ES";

    public override int TimeframeMinutes => 30;

    public override string ResearchCode => "ES-30M-RHL-a8743f";

    public PT5DAV_ES_RHL_001_30()
    {
        ...
        MaxBars = 138;                          // max_bars (la giornata della ricerca in barre)
