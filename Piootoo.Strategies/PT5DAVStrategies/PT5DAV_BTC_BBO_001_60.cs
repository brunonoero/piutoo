...
/// <summary>
/// <b>PT5DAV_BTC_BBO_001_60</b> — BIAS_BO su BTC 1h, codice della ricerca <c>BTC-1H-BIASBO-13c5d9</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 683 trade, netto $504,896; broker (27/08/2025 → 09/09/2026)
/// 138 trade, netto $-177,960. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/BTC-1H-BIASBO-13c5d9.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (26/12/2017 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $504,896 su 683 trade · $739 a trade · drawdown $93,374 · netto/DD 5.41 · anni in perdita 1 su 8 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $208,897 su 683 trade, drawdown $43,295.</para>
...
/// <para>· L'ordine LONG esiste solo dalla barra 5 (inclusa) alla barra 7 (esclusa) della sessione; lo SHORT dalla 1 alla 7.</para>
...
/// <para>· Uscita obbligatoria alla barra 17 della sessione per il LONG e alla barra 3 per lo SHORT, market all'apertura di quella barra.</para>
...
/// </summary>
public sealed class PT5DAV_BTC_BBO_001_60 : Pt5DavBiasBreakoutEngine
{
    public override string Name => "PT5DAV_BTC_BBO_001_60";

    public override string Description => "BIAS_BO BTC 1h, ricerca PT5DAV BTC-1H-BIASBO-13c5d9";

    public override string Symbol => "@BTC";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "BTC-1H-BIASBO-13c5d9";

    public PT5DAV_BTC_BBO_001_60()
    {
