...
/// <summary>
/// <b>PT5DAV_KC_RBM_001_15</b> — RBB_M su KC 15m, codice della ricerca <c>KC-15M-RBBM-603b3b</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 134 trade, netto $59,074; broker (27/08/2025 → 09/09/2026)
/// 7 trade, netto $-3,196. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/KC-15M-RBBM-603b3b.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $59,074 su 134 trade · $441 a trade · drawdown $11,632 · netto/DD 5.08 · anni in perdita 4 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $36,136 su 134 trade, drawdown $5,869.</para>
...
/// </summary>
public sealed class PT5DAV_KC_RBM_001_15 : Pt5DavBollingerMirroredEngine
{
    public override string Name => "PT5DAV_KC_RBM_001_15";

    public override string Description => "RBB_M KC 15m, ricerca PT5DAV KC-15M-RBBM-603b3b";

    public override string Symbol => "@KC";

    public override int TimeframeMinutes => 15;

    public override string ResearchCode => "KC-15M-RBBM-603b3b";

    public PT5DAV_KC_RBM_001_15()
    {
