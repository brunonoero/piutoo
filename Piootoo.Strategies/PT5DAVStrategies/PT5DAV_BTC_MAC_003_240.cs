...
/// <summary>
/// <b>PT5DAV_BTC_MAC_003_240</b> — MAC su BTC 4h, codice della ricerca <c>BTC-4H-MAC-f77a19</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 67 trade, netto $401,525; broker (27/08/2025 → 09/09/2026)
/// 9 trade, netto $28,174. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/BTC-4H-MAC-f77a19.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (26/12/2017 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $401,525 su 67 trade · $5,993 a trade · drawdown $46,521 · netto/DD 8.63 · anni in perdita 2 su 8 · notti a mercato 2.37 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $204,520 su 67 trade, drawdown $23,808.</para>
...
/// </summary>
public sealed class PT5DAV_BTC_MAC_003_240 : Pt5DavMovingAverageCrossoverEngine
{
    public override string Name => "PT5DAV_BTC_MAC_003_240";

    public override string Description => "MAC BTC 4h, ricerca PT5DAV BTC-4H-MAC-f77a19";

    public override string Symbol => "@BTC";

    public override int TimeframeMinutes => 240;

    public override string ResearchCode => "BTC-4H-MAC-f77a19";

    public PT5DAV_BTC_MAC_003_240()
    {
