...
/// <summary>
/// <b>PT5DAV_NQ_RHL_004_240</b> — RHL su NQ 4h, codice della ricerca <c>NQ-4H-RHL-4cd2c3</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 513 trade, netto $837,234; broker (27/08/2025 → 09/09/2026)
/// 44 trade, netto $27,908. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/NQ-4H-RHL-4cd2c3.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $837,234 su 513 trade · $1,632 a trade · drawdown $106,207 · netto/DD 7.88 · anni in perdita 2 su 14 · notti a mercato 3.30 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $307,222 su 513 trade, drawdown $56,952.</para>
...
/// </summary>
public sealed class PT5DAV_NQ_RHL_004_240 : Pt5DavRhlEngine
{
    public override string Name => "PT5DAV_NQ_RHL_004_240";

    public override string Description => "RHL NQ 4h, ricerca PT5DAV NQ-4H-RHL-4cd2c3";

    public override string Symbol => "@NQ";

    public override int TimeframeMinutes => 240;

    public override string ResearchCode => "NQ-4H-RHL-4cd2c3";

    public PT5DAV_NQ_RHL_004_240()
    {
