...
/// <summary>
/// <b>PT5DAV_YM_LFD_003_60</b> — LF su YM 1h, codice della ricerca <c>YM-1H-LF-db5892</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 585 trade, netto $118,694; broker (27/08/2025 → 09/09/2026)
/// 62 trade, netto $7,744. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/YM-1H-LF-db5892.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $118,694 su 585 trade · $203 a trade · drawdown $14,485 · netto/DD 8.19 · anni in perdita 3 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $44,217 su 585 trade, drawdown $10,794.</para>
...
/// <para>· Opera solo fra 06:00 e 18:00, CET: ordini emessi sulle barre che chiudono fra le 06:00 e le 18:00 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_YM_LFD_003_60 : Pt5DavPivotFaderEngine
{
    public override string Name => "PT5DAV_YM_LFD_003_60";

    public override string Description => "LF YM 1h, ricerca PT5DAV YM-1H-LF-db5892";

    public override string Symbol => "@YM";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "YM-1H-LF-db5892";

    public PT5DAV_YM_LFD_003_60()
    {
        TradingWindow = ResearchWindow(6, 18);  // start_hour 6, end_hour 18, verbatim
