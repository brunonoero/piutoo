...
/// <summary>
/// <b>PT5DAV_BP_LFD_003_15</b> — LF su BP 15m, codice della ricerca <c>BP-15M-LF-609b39</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 52 trade, netto $13,219; broker (27/08/2025 → 09/09/2026)
/// 3 trade, netto $166. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/BP-15M-LF-609b39.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $13,219 su 52 trade · $254 a trade · drawdown $2,221 · netto/DD 5.95 · anni in perdita 3 su 12 · notti a mercato 5.23 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $11,566 su 52 trade, drawdown $2,149.</para>
...
/// <para>· Opera solo fra 13:00 e 14:00, CET: ordini emessi sulle barre che chiudono fra le 13:00 e le 14:00 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_BP_LFD_003_15 : Pt5DavPivotFaderEngine
{
    public override string Name => "PT5DAV_BP_LFD_003_15";

    public override string Description => "LF BP 15m, ricerca PT5DAV BP-15M-LF-609b39";

    public override string Symbol => "@BP";

    public override int TimeframeMinutes => 15;

    public override string ResearchCode => "BP-15M-LF-609b39";

    public PT5DAV_BP_LFD_003_15()
    {
        TradingWindow = ResearchWindow(13, 14); // start_hour 13, end_hour 14, verbatim
