...
/// <summary>
/// <b>PT5DAV_YM_RBM_003_60</b> — RBB_M su YM 1h, codice della ricerca <c>YM-1H-RBBM-324e1f</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 2243 trade, netto $110,046; broker (27/08/2025 → 09/09/2026)
/// 160 trade, netto $-10,901. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/YM-1H-RBBM-324e1f.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $110,046 su 2243 trade · $49 a trade · drawdown $64,248 · netto/DD 1.71 · anni in perdita 4 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $23,207 su 2243 trade, drawdown $40,477.</para>
...
/// <para>· Opera solo fra 18:00 e 02:00 (a cavallo della mezzanotte), CET: ordini emessi sulle barre che chiudono fra le 18:00 e le 02:00 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_YM_RBM_003_60 : Pt5DavBollingerMirroredEngine
{
    public override string Name => "PT5DAV_YM_RBM_003_60";

    public override string Description => "RBB_M YM 1h, ricerca PT5DAV YM-1H-RBBM-324e1f";

    public override string Symbol => "@YM";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "YM-1H-RBBM-324e1f";

    public PT5DAV_YM_RBM_003_60()
    {
        TradingWindow = ResearchWindow(18, 2);  // start_hour 18, end_hour 2, verbatim
