...
/// <summary>
/// <b>PT5DAV_CL_LFH_002_60</b> — LF_HL su CL 1h, codice della ricerca <c>CL-1H-LFHL-c58d20</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 50 trade, netto $45,993; broker (27/08/2025 → 09/09/2026)
/// 7 trade, netto $4,295. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/CL-1H-LFHL-c58d20.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $45,993 su 50 trade · $920 a trade · drawdown $5,223 · netto/DD 8.81 · anni in perdita 1 su 13 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $28,993 su 50 trade, drawdown $5,852.</para>
...
/// <para>· Opera solo fra 05:00 e 12:00, CET: ordini emessi sulle barre che chiudono fra le 05:00 e le 12:00 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_CL_LFH_002_60 : Pt5DavHighLowFaderEngine
{
    public override string Name => "PT5DAV_CL_LFH_002_60";

    public override string Description => "LF_HL CL 1h, ricerca PT5DAV CL-1H-LFHL-c58d20";

    public override string Symbol => "@CL";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "CL-1H-LFHL-c58d20";

    public PT5DAV_CL_LFH_002_60()
    {
        TradingWindow = ResearchWindow(5, 12);  // start_hour 5, end_hour 12, verbatim
