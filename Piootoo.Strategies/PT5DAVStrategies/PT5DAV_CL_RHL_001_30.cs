...
/// <summary>
/// <b>PT5DAV_CL_RHL_001_30</b> — RHL su CL 30m, codice della ricerca <c>CL-30M-RHL-8b2671</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 80 trade, netto $331,611; broker (27/08/2025 → 09/09/2026)
/// 15 trade, netto $23,139. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/CL-30M-RHL-8b2671.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $331,611 su 80 trade · $4,145 a trade · drawdown $13,850 · netto/DD 23.94 · anni in perdita 1 su 13 · notti a mercato 5.61 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $160,077 su 80 trade, drawdown $16,065.</para>
...
/// </summary>
public sealed class PT5DAV_CL_RHL_001_30 : Pt5DavRhlEngine
{
    public override string Name => "PT5DAV_CL_RHL_001_30";

    public override string Description => "RHL CL 30m, ricerca PT5DAV CL-30M-RHL-8b2671";
