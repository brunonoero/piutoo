...
/// <summary>
/// <b>PT5DAV_NQ_BOS_003_60</b> — BO_S su NQ 1h, codice della ricerca <c>NQ-1H-BOS-979677</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 2442 trade, netto $1,117,799; broker (27/08/2025 → 09/09/2026)
/// 197 trade, netto $-8,843. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/NQ-1H-BOS-979677.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $1,117,799 su 2442 trade · $458 a trade · drawdown $98,834 · netto/DD 11.31 · anni in perdita 0 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $323,128 su 2442 trade, drawdown $41,578.</para>
...
/// </summary>
public sealed class PT5DAV_NQ_BOS_003_60 : Pt5DavCurrentSessionBreakoutEngine
{
    public override string Name => "PT5DAV_NQ_BOS_003_60";

    public override string Description => "BO_S NQ 1h, ricerca PT5DAV NQ-1H-BOS-979677";

    public override string Symbol => "@NQ";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "NQ-1H-BOS-979677";

    public PT5DAV_NQ_BOS_003_60()
    {
