...
/// <summary>
/// <b>PT5DAV_YM_TFM_002_240</b> — TF_M su YM 4h, codice della ricerca <c>YM-4H-TFM-49c3d4</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 814 trade, netto $127,599; broker (27/08/2025 → 09/09/2026)
/// 69 trade, netto $4,574. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/YM-4H-TFM-49c3d4.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $127,599 su 814 trade · $157 a trade · drawdown $20,503 · netto/DD 6.22 · anni in perdita 3 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $60,194 su 814 trade, drawdown $10,392.</para>
...
/// </summary>
public sealed class PT5DAV_YM_TFM_002_240 : Pt5DavTfMirroredEngine
{
    public override string Name => "PT5DAV_YM_TFM_002_240";

    public override string Description => "TF_M YM 4h, ricerca PT5DAV YM-4H-TFM-49c3d4";

    public override string Symbol => "@YM";

    public override int TimeframeMinutes => 240;

    public override string ResearchCode => "YM-4H-TFM-49c3d4";

    public PT5DAV_YM_TFM_002_240()
    {
