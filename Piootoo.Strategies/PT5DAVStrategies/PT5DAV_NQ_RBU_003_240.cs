...
/// <summary>
/// <b>PT5DAV_NQ_RBU_003_240</b> — RBB_U su NQ 4h, codice della ricerca <c>NQ-4H-RBBU-ece922</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 742 trade, netto $149,020; broker (27/08/2025 → 09/09/2026)
/// 55 trade, netto $-16,570. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/NQ-4H-RBBU-ece922.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $149,020 su 742 trade · $201 a trade · drawdown $27,206 · netto/DD 5.48 · anni in perdita 4 su 14 · notti a mercato 0.02 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $54,002 su 742 trade, drawdown $10,812.</para>
...
/// <para>· Opera solo fra 08:00 e 23:59, CET: ordini emessi sulle barre che chiudono fra le 08:00 e le 23:59 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// <para>· Take profit: 0.20 × ATR50 dal prezzo d'ingresso</para>
/// <para>· Nessuna uscita a tempo</para>
/// </summary>
public sealed class PT5DAV_NQ_RBU_003_240 : Pt5DavBollingerUnmirroredEngine
{
    public override string Name => "PT5DAV_NQ_RBU_003_240";

    public override string Description => "RBB_U NQ 4h, ricerca PT5DAV NQ-4H-RBBU-ece922";

    public override string Symbol => "@NQ";

    public override int TimeframeMinutes => 240;

    public override string ResearchCode => "NQ-4H-RBBU-ece922";

    public PT5DAV_NQ_RBU_003_240()
    {
        TradingWindow = ResearchWindow(8, -1);  // start_hour 8, end_hour -1, verbatim
        ...
        TargetAtr = 0.2m;                       // take_profit_atr
    }
}
