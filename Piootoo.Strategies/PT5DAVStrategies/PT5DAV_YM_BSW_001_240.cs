...
/// <summary>
/// <b>PT5DAV_YM_BSW_001_240</b> — BIASW su YM 4h, codice della ricerca <c>YM-4H-BIASW-8adfb4</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 676 trade, netto $211,177; broker (27/08/2025 → 09/09/2026)
/// 50 trade, netto $18,475. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/YM-4H-BIASW-8adfb4.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $211,177 su 676 trade · $312 a trade · drawdown $30,448 · netto/DD 6.94 · anni in perdita 3 su 14 · notti a mercato 1.04 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $109,416 su 676 trade, drawdown $14,152.</para>
...
/// <para>· Uscita LONG: martedì alle 12:00, market alla chiusura della barra che termina a quell'ora.</para>
...
/// </summary>
public sealed class PT5DAV_YM_BSW_001_240 : Pt5DavBiasWeeklyEngine
{
    public override string Name => "PT5DAV_YM_BSW_001_240";

    public override string Description => "BIASW YM 4h, ricerca PT5DAV YM-4H-BIASW-8adfb4";

    public override string Symbol => "@YM";

    public override int TimeframeMinutes => 240;

    public override string ResearchCode => "YM-4H-BIASW-8adfb4";

    public PT5DAV_YM_BSW_001_240()
    {
        ...
        ExitDayLong = 1;                        // lx_day, pandas
        ExitTimeLong = new TimeOnly(12, 0);     // lx_time 1200: chiude la barra d'uscita
