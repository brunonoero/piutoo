...
/// <summary>
/// <b>PT5DAV_BTC_LFD_001_15</b> — LF su BTC 15m, codice della ricerca <c>BTC-15M-LF-e49442</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 165 trade, netto $330,748; broker (27/08/2025 → 09/09/2026)
/// 36 trade, netto $-60,720. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/BTC-15M-LF-e49442.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (26/12/2017 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $330,748 su 165 trade · $2,005 a trade · drawdown $37,871 · netto/DD 8.73 · anni in perdita 2 su 8 · notti a mercato 0.62 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $169,221 su 165 trade, drawdown $27,069.</para>
...
/// </summary>
public sealed class PT5DAV_BTC_LFD_001_15 : Pt5DavPivotFaderEngine
{
    public override string Name => "PT5DAV_BTC_LFD_001_15";

    public override string Description => "LF BTC 15m, ricerca PT5DAV BTC-15M-LF-e49442";

    public override string Symbol => "@BTC";

    public override int TimeframeMinutes => 15;

    public override string ResearchCode => "BTC-15M-LF-e49442";

    public PT5DAV_BTC_LFD_001_15()
    {
