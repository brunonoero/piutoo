...
/// <summary>
/// <b>PT5DAV_BP_LFD_002_240</b> — LF su BP 4h, codice della ricerca <c>BP-4H-LF-f437ae</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 66 trade, netto $5,757; broker (27/08/2025 → 09/09/2026)
/// 5 trade, netto $-161. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/BP-4H-LF-f437ae.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $5,757 su 66 trade · $87 a trade · drawdown $1,440 · netto/DD 4.00 · anni in perdita 4 su 14 · notti a mercato 1.67 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $5,764 su 66 trade, drawdown $1,400.</para>
...
/// </summary>
public sealed class PT5DAV_BP_LFD_002_240 : Pt5DavPivotFaderEngine
{
    public override string Name => "PT5DAV_BP_LFD_002_240";

    public override string Description => "LF BP 4h, ricerca PT5DAV BP-4H-LF-f437ae";

    public override string Symbol => "@BP";

    public override int TimeframeMinutes => 240;

    public override string ResearchCode => "BP-4H-LF-f437ae";

    public PT5DAV_BP_LFD_002_240()
    {
