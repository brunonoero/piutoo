...
/// <summary>
/// <b>PT5DAV_ES_MAC_001_30</b> — MAC su ES 30m, codice della ricerca <c>ES-30M-MAC-1dbff7</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 648 trade, netto $127,895; broker (27/08/2025 → 09/09/2026)
/// 41 trade, netto $4,342. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/ES-30M-MAC-1dbff7.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $127,895 su 648 trade · $197 a trade · drawdown $28,194 · netto/DD 4.54 · anni in perdita 4 su 14 · notti a mercato 0.77 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $62,218 su 648 trade, drawdown $12,639.</para>
...
/// </summary>
public sealed class PT5DAV_ES_MAC_001_30 : Pt5DavMovingAverageCrossoverEngine
{
    public override string Name => "PT5DAV_ES_MAC_001_30";

    public override string Description => "MAC ES 30m, ricerca PT5DAV ES-30M-MAC-1dbff7";

    public override string Symbol => "@ES";

    public override int TimeframeMinutes => 30;

    public override string ResearchCode => "ES-30M-MAC-1dbff7";

    public PT5DAV_ES_MAC_001_30()
    {
