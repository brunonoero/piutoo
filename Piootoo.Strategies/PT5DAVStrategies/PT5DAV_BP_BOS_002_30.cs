...
/// <summary>
/// <b>PT5DAV_BP_BOS_002_30</b> — BO_S su BP 30m, codice della ricerca <c>BP-30M-BOS-feff2b</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 103 trade, netto $16,280; broker (27/08/2025 → 09/09/2026)
/// 14 trade, netto $201. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/BP-30M-BOS-feff2b.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $16,280 su 103 trade · $158 a trade · drawdown $1,622 · netto/DD 10.04 · anni in perdita 3 su 14 · notti a mercato 0.53 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $15,338 su 103 trade, drawdown $1,777.</para>
...
/// <para>· deve essere VERO — neutrale 18: '|O_d5-C_d1| &gt; 0.75 * (H_d5-L_d1)'</para>
...
/// </summary>
public sealed class PT5DAV_BP_BOS_002_30 : Pt5DavCurrentSessionBreakoutEngine
{
    public override string Name => "PT5DAV_BP_BOS_002_30";

    public override string Description => "BO_S BP 30m, ricerca PT5DAV BP-30M-BOS-feff2b";

    public override string Symbol => "@BP";

    public override int TimeframeMinutes => 30;

    public override string ResearchCode => "BP-30M-BOS-feff2b";

    public PT5DAV_BP_BOS_002_30()
    {
        TradingWindow = ResearchWindow(-1, 1);  // start_hour -1, end_hour 1, verbatim
        OffsetAtr = 0.1m;                       // breakout_offset_atr
        NeutralYes = 18;                        // ptn_neut_yes
