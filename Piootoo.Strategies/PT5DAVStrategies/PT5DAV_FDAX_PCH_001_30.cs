...
/// <summary>
/// <b>PT5DAV_FDAX_PCH_001_30</b> — PC su FDAX 30m, codice della ricerca <c>FDAX-30M-PC-aa3ddd</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 682 trade, netto $423,940; broker (27/08/2025 → 09/09/2026)
/// 50 trade, netto $-35,159. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/FDAX-30M-PC-aa3ddd.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $423,940 su 682 trade · $622 a trade · drawdown $49,868 · netto/DD 8.50 · anni in perdita 2 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $140,643 su 682 trade, drawdown $25,040.</para>
...
/// <para>· Opera solo fra 10:00 e 17:00, CET: ordini emessi sulle barre che chiudono fra le 10:00 e le 17:00 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_FDAX_PCH_001_30 : Pt5DavPriceChannelEngine
{
    public override string Name => "PT5DAV_FDAX_PCH_001_30";

    public override string Description => "PC FDAX 30m, ricerca PT5DAV FDAX-30M-PC-aa3ddd";

    public override string Symbol => "@FDAX";

    public override int TimeframeMinutes => 30;

    public override string ResearchCode => "FDAX-30M-PC-aa3ddd";

    public PT5DAV_FDAX_PCH_001_30()
    {
        TradingWindow = ResearchWindow(10, 17); // start_hour 10, end_hour 17, verbatim
