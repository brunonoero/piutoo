...
/// <summary>
/// <b>PT5DAV_YM_MAC_003_60</b> — MAC su YM 1h, codice della ricerca <c>YM-1H-MAC-1d01cc</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 472 trade, netto $148,462; broker (27/08/2025 → 09/09/2026)
/// 31 trade, netto $4,187. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/YM-1H-MAC-1d01cc.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $148,462 su 472 trade · $315 a trade · drawdown $30,673 · netto/DD 4.84 · anni in perdita 3 su 14 · notti a mercato 1.77 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $76,344 su 472 trade, drawdown $15,588.</para>
...
/// </summary>
public sealed class PT5DAV_YM_MAC_003_60 : Pt5DavMovingAverageCrossoverEngine
{
    public override string Name => "PT5DAV_YM_MAC_003_60";

    public override string Description => "MAC YM 1h, ricerca PT5DAV YM-1H-MAC-1d01cc";

    public override string Symbol => "@YM";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "YM-1H-MAC-1d01cc";

    public PT5DAV_YM_MAC_003_60()
    {
