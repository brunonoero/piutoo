...
/// <summary>
/// <b>PT5DAV_ES_LFH_001_60</b> — LF_HL su ES 1h, codice della ricerca <c>ES-1H-LFHL-28652f</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 54 trade, netto $178,367; broker (27/08/2025 → 09/09/2026)
/// 1 trade, netto $-2,537. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/ES-1H-LFHL-28652f.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $178,367 su 54 trade · $3,303 a trade · drawdown $17,384 · netto/DD 10.26 · anni in perdita 3 su 12 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $64,968 su 54 trade, drawdown $9,529.</para>
...
/// </summary>
public sealed class PT5DAV_ES_LFH_001_60 : Pt5DavHighLowFaderEngine
{
    public override string Name => "PT5DAV_ES_LFH_001_60";

    public override string Description => "LF_HL ES 1h, ricerca PT5DAV ES-1H-LFHL-28652f";

    public override string Symbol => "@ES";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "ES-1H-LFHL-28652f";

    public PT5DAV_ES_LFH_001_60()
    {
