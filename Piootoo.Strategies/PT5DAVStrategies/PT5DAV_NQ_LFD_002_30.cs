...
/// <summary>
/// <b>PT5DAV_NQ_LFD_002_30</b> — LF su NQ 30m, codice della ricerca <c>NQ-30M-LF-82d4e0</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 358 trade, netto $565,108; broker (27/08/2025 → 09/09/2026)
/// 61 trade, netto $55,757. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/NQ-30M-LF-82d4e0.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $565,108 su 358 trade · $1,579 a trade · drawdown $41,780 · netto/DD 13.53 · anni in perdita 1 su 14 · notti a mercato 1.28 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $216,290 su 358 trade, drawdown $16,210.</para>
...
/// </summary>
public sealed class PT5DAV_NQ_LFD_002_30 : Pt5DavPivotFaderEngine
{
    public override string Name => "PT5DAV_NQ_LFD_002_30";

    public override string Description => "LF NQ 30m, ricerca PT5DAV NQ-30M-LF-82d4e0";

    public override string Symbol => "@NQ";

    public override int TimeframeMinutes => 30;

    public override string ResearchCode => "NQ-30M-LF-82d4e0";

    public PT5DAV_NQ_LFD_002_30()
    {
