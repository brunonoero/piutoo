...
/// <summary>
/// <b>PT5DAV_ES_MAC_002_60</b> — MAC su ES 1h, codice della ricerca <c>ES-1H-MAC-8e0899</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 297 trade, netto $209,612; broker (27/08/2025 → 09/09/2026)
/// 14 trade, netto $10,448. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/ES-1H-MAC-8e0899.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $209,612 su 297 trade · $706 a trade · drawdown $16,757 · netto/DD 12.51 · anni in perdita 2 su 14 · notti a mercato 1.35 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $86,028 su 297 trade, drawdown $12,521.</para>
...
/// <para>· Filtro gradiente: su 5 barre la veloce deve essersi mossa, in valore assoluto, almeno 0.8 volte quanto la lenta nello stesso tratto.</para>
...
/// </summary>
public sealed class PT5DAV_ES_MAC_002_60 : Pt5DavMovingAverageCrossoverEngine
{
    public override string Name => "PT5DAV_ES_MAC_002_60";

    public override string Description => "MAC ES 1h, ricerca PT5DAV ES-1H-MAC-8e0899";

    public override string Symbol => "@ES";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "ES-1H-MAC-8e0899";

    public PT5DAV_ES_MAC_002_60()
    {
