...
/// <summary>
/// <b>PT5DAV_FDAX_RHL_002_60</b> — RHL su FDAX 1h, codice della ricerca <c>FDAX-1H-RHL-38fb85</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 464 trade, netto $904,618; broker (27/08/2025 → 09/09/2026)
/// 23 trade, netto $82,000. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/FDAX-1H-RHL-38fb85.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $904,618 su 464 trade · $1,950 a trade · drawdown $171,666 · netto/DD 5.27 · anni in perdita 2 su 14 · notti a mercato 3.63 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $518,281 su 464 trade, drawdown $67,902.</para>
...
/// </summary>
public sealed class PT5DAV_FDAX_RHL_002_60 : Pt5DavRhlEngine
{
    public override string Name => "PT5DAV_FDAX_RHL_002_60";

    public override string Description => "RHL FDAX 1h, ricerca PT5DAV FDAX-1H-RHL-38fb85";

    public override string Symbol => "@FDAX";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "FDAX-1H-RHL-38fb85";

    public PT5DAV_FDAX_RHL_002_60()
    {
