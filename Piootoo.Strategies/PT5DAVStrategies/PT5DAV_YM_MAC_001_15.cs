...
/// <summary>
/// <b>PT5DAV_YM_MAC_001_15</b> — MAC su YM 15m, codice della ricerca <c>YM-15M-MAC-87cbcb</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 989 trade, netto $108,698; broker (27/08/2025 → 09/09/2026)
/// 84 trade, netto $-5,569. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/YM-15M-MAC-87cbcb.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $108,698 su 989 trade · $110 a trade · drawdown $15,873 · netto/DD 6.85 · anni in perdita 4 su 14 · notti a mercato 0.31 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $40,947 su 989 trade, drawdown $10,795.</para>
...
/// </summary>
public sealed class PT5DAV_YM_MAC_001_15 : Pt5DavMovingAverageCrossoverEngine
{
    public override string Name => "PT5DAV_YM_MAC_001_15";

    public override string Description => "MAC YM 15m, ricerca PT5DAV YM-15M-MAC-87cbcb";

    public override string Symbol => "@YM";

    public override int TimeframeMinutes => 15;

    public override string ResearchCode => "YM-15M-MAC-87cbcb";

    public PT5DAV_YM_MAC_001_15()
    {
