...
/// <summary>
/// <b>PT5DAV_YM_RBU_001_60</b> — RBB_U su YM 1h, codice della ricerca <c>YM-1H-RBBU-b5b54f</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 1378 trade, netto $89,703; broker (27/08/2025 → 09/09/2026)
/// 116 trade, netto $-3,237. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/YM-1H-RBBU-b5b54f.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $89,703 su 1378 trade · $65 a trade · drawdown $19,803 · netto/DD 4.53 · anni in perdita 4 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $33,886 su 1378 trade, drawdown $11,337.</para>
...
/// <para>· Opera solo fra 13:00 e 23:59, CET: ordini emessi sulle barre che chiudono fra le 13:00 e le 23:59 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_YM_RBU_001_60 : Pt5DavBollingerUnmirroredEngine
{
    public override string Name => "PT5DAV_YM_RBU_001_60";

    public override string Description => "RBB_U YM 1h, ricerca PT5DAV YM-1H-RBBU-b5b54f";

    public override string Symbol => "@YM";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "YM-1H-RBBU-b5b54f";

    public PT5DAV_YM_RBU_001_60()
    {
        TradingWindow = ResearchWindow(13, -1); // start_hour 13, end_hour -1, verbatim
