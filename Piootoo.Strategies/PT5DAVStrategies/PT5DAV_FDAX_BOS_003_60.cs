...
/// <summary>
/// <b>PT5DAV_FDAX_BOS_003_60</b> — BO_S su FDAX 1h, codice della ricerca <c>FDAX-1H-BOS-541680</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 1943 trade, netto $588,325; broker (27/08/2025 → 09/09/2026)
/// 143 trade, netto $28,399. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/FDAX-1H-BOS-541680.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $588,325 su 1943 trade · $303 a trade · drawdown $102,608 · netto/DD 5.73 · anni in perdita 3 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $204,416 su 1943 trade, drawdown $62,344.</para>
...
/// </summary>
public sealed class PT5DAV_FDAX_BOS_003_60 : Pt5DavCurrentSessionBreakoutEngine
{
    public override string Name => "PT5DAV_FDAX_BOS_003_60";

    public override string Description => "BO_S FDAX 1h, ricerca PT5DAV FDAX-1H-BOS-541680";

    public override string Symbol => "@FDAX";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "FDAX-1H-BOS-541680";

    public PT5DAV_FDAX_BOS_003_60()
    {
