...
/// <summary>
/// <b>PT5DAV_BP_PCH_001_30</b> — PC su BP 30m, codice della ricerca <c>BP-30M-PC-1a7d28</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 3496 trade, netto $53,637; broker (27/08/2025 → 09/09/2026)
/// 269 trade, netto $-9,123. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/BP-30M-PC-1a7d28.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $53,637 su 3496 trade · $15 a trade · drawdown $11,079 · netto/DD 4.84 · anni in perdita 4 su 14 · notti a mercato 1.32 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $22,897 su 3496 trade, drawdown $15,509.</para>
...
/// <para>· Opera solo fra 09:00 e 04:00 (a cavallo della mezzanotte), CET: ordini emessi sulle barre che chiudono fra le 09:00 e le 04:00 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_BP_PCH_001_30 : Pt5DavPriceChannelEngine
{
    public override string Name => "PT5DAV_BP_PCH_001_30";

    public override string Description => "PC BP 30m, ricerca PT5DAV BP-30M-PC-1a7d28";

    public override string Symbol => "@BP";

    public override int TimeframeMinutes => 30;

    public override string ResearchCode => "BP-30M-PC-1a7d28";

    public PT5DAV_BP_PCH_001_30()
    {
        TradingWindow = ResearchWindow(9, 4);   // start_hour 9, end_hour 4, verbatim
