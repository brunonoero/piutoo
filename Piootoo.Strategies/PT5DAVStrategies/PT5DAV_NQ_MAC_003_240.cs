...
/// <summary>
/// <b>PT5DAV_NQ_MAC_003_240</b> — MAC su NQ 4h, codice della ricerca <c>NQ-4H-MAC-75a060</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 243 trade, netto $169,362; broker (27/08/2025 → 09/09/2026)
/// 22 trade, netto $-36,528. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/NQ-4H-MAC-75a060.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $169,362 su 243 trade · $697 a trade · drawdown $36,831 · netto/DD 4.60 · anni in perdita 3 su 14 · notti a mercato 1.17 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $61,461 su 243 trade, drawdown $16,824.</para>
...
/// </summary>
public sealed class PT5DAV_NQ_MAC_003_240 : Pt5DavMovingAverageCrossoverEngine
{
    public override string Name => "PT5DAV_NQ_MAC_003_240";

    public override string Description => "MAC NQ 4h, ricerca PT5DAV NQ-4H-MAC-75a060";

    public override string Symbol => "@NQ";

    public override int TimeframeMinutes => 240;

    public override string ResearchCode => "NQ-4H-MAC-75a060";

    public PT5DAV_NQ_MAC_003_240()
    {
