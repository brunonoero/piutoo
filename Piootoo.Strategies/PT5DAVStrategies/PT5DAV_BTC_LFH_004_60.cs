...
/// <summary>
/// <b>PT5DAV_BTC_LFH_004_60</b> — LF_HL su BTC 1h, codice della ricerca <c>BTC-1H-LFHL-66e894</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 57 trade, netto $464,409; broker (27/08/2025 → 09/09/2026)
/// 17 trade, netto $-21,668. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/BTC-1H-LFHL-66e894.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (26/12/2017 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $464,409 su 57 trade · $8,148 a trade · drawdown $72,760 · netto/DD 6.38 · anni in perdita 1 su 8 · notti a mercato 5.49 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $193,687 su 57 trade, drawdown $55,824.</para>
...
/// </summary>
public sealed class PT5DAV_BTC_LFH_004_60 : Pt5DavHighLowFaderEngine
{
    public override string Name => "PT5DAV_BTC_LFH_004_60";

    public override string Description => "LF_HL BTC 1h, ricerca PT5DAV BTC-1H-LFHL-66e894";

    public override string Symbol => "@BTC";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "BTC-1H-LFHL-66e894";

    public PT5DAV_BTC_LFH_004_60()
    {
