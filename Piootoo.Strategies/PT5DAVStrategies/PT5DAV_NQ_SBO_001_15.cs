...
/// <summary>
/// <b>PT5DAV_NQ_SBO_001_15</b> — BO su NQ 15m, codice della ricerca <c>NQ-15M-BO-b752d0</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 702 trade, netto $366,542; broker (27/08/2025 → 09/09/2026)
/// 58 trade, netto $27,213. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/NQ-15M-BO-b752d0.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $366,542 su 702 trade · $522 a trade · drawdown $46,759 · netto/DD 7.84 · anni in perdita 4 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $155,799 su 702 trade, drawdown $18,356.</para>
...
/// <para>· Opera solo fra 17:00 e 22:00, CET: ordini emessi sulle barre che chiudono fra le 17:00 e le 22:00 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_NQ_SBO_001_15 : Pt5DavSessionBreakoutEngine
{
    public override string Name => "PT5DAV_NQ_SBO_001_15";

    public override string Description => "BO NQ 15m, ricerca PT5DAV NQ-15M-BO-b752d0";

    public override string Symbol => "@NQ";

    public override int TimeframeMinutes => 15;

    public override string ResearchCode => "NQ-15M-BO-b752d0";

    public PT5DAV_NQ_SBO_001_15()
    {
        TradingWindow = ResearchWindow(17, 22); // start_hour 17, end_hour 22, verbatim
        Sessions = 2;                           // n_sess
