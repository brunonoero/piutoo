...
/// <summary>
/// <b>PT5DAV_NQ_RHL_003_60</b> — RHL su NQ 1h, codice della ricerca <c>NQ-1H-RHL-0d0b7b</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 67 trade, netto $594,969; broker (27/08/2025 → 09/09/2026)
/// 1 trade, netto $11,685. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/NQ-1H-RHL-0d0b7b.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $594,969 su 67 trade · $8,880 a trade · drawdown $42,594 · netto/DD 13.97 · anni in perdita 3 su 11 · notti a mercato 1.94 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $195,783 su 67 trade, drawdown $16,971.</para>
...
/// <para>Solo LONG</para>
/// <para>· deve essere VERO — direzionale 31: 'H_d0 &lt; H_d1 * (1 - 0.02)'</para>
/// <para>Solo SHORT</para>
/// <para>· deve essere VERO — direzionale 31: 'L_d0 &gt; L_d1 * (1 + 0.02)'</para>
/// <para><b>Quando puo' operare</b></para>
/// <para>· Opera solo fra 02:00 e 17:00, CET: ordini emessi sulle barre che chiudono fra le 02:00 e le 17:00 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_NQ_RHL_003_60 : Pt5DavRhlEngine
{
    public override string Name => "PT5DAV_NQ_RHL_003_60";

    public override string Description => "RHL NQ 1h, ricerca PT5DAV NQ-1H-RHL-0d0b7b";

    public override string Symbol => "@NQ";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "NQ-1H-RHL-0d0b7b";

    public PT5DAV_NQ_RHL_003_60()
    {
        TradingWindow = ResearchWindow(2, 17);  // start_hour 2, end_hour 17, verbatim
