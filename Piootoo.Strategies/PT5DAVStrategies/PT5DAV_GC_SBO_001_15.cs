...
/// <summary>
/// <b>PT5DAV_GC_SBO_001_15</b> — BO su GC 15m, codice della ricerca <c>GC-15M-BO-b7d6e3</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 518 trade, netto $262,490; broker (27/08/2025 → 09/09/2026)
/// 32 trade, netto $20,145. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/GC-15M-BO-b7d6e3.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $262,490 su 518 trade · $507 a trade · drawdown $73,388 · netto/DD 3.58 · anni in perdita 2 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $94,885 su 518 trade, drawdown $30,830.</para>
...
/// </summary>
public sealed class PT5DAV_GC_SBO_001_15 : Pt5DavSessionBreakoutEngine
{
    public override string Name => "PT5DAV_GC_SBO_001_15";

    public override string Description => "BO GC 15m, ricerca PT5DAV GC-15M-BO-b7d6e3";

    public override string Symbol => "@GC";

    public override int TimeframeMinutes => 15;

    public override string ResearchCode => "GC-15M-BO-b7d6e3";

    public PT5DAV_GC_SBO_001_15()
    {
