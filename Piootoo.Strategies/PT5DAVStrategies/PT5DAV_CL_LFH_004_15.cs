...
/// <summary>
/// <b>PT5DAV_CL_LFH_004_15</b> — LF_HL su CL 15m, codice della ricerca <c>CL-15M-LFHL-dfb899</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 54 trade, netto $192,319; broker (27/08/2025 → 09/09/2026)
/// 12 trade, netto $-17,369. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/CL-15M-LFHL-dfb899.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $192,319 su 54 trade · $3,561 a trade · drawdown $10,391 · netto/DD 18.51 · anni in perdita 2 su 13 · notti a mercato 7.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $68,475 su 54 trade, drawdown $11,612.</para>
...
/// </summary>
public sealed class PT5DAV_CL_LFH_004_15 : Pt5DavHighLowFaderEngine
{
    public override string Name => "PT5DAV_CL_LFH_004_15";

    public override string Description => "LF_HL CL 15m, ricerca PT5DAV CL-15M-LFHL-dfb899";

    public override string Symbol => "@CL";

    public override int TimeframeMinutes => 15;

    public override string ResearchCode => "CL-15M-LFHL-dfb899";

    public PT5DAV_CL_LFH_004_15()
    {
