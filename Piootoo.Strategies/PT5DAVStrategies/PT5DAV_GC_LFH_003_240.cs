...
/// <summary>
/// <b>PT5DAV_GC_LFH_003_240</b> — LF_HL su GC 4h, codice della ricerca <c>GC-4H-LFHL-8e771a</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 107 trade, netto $255,505; broker (27/08/2025 → 09/09/2026)
/// 8 trade, netto $-48,285. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/GC-4H-LFHL-8e771a.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $255,505 su 107 trade · $2,388 a trade · drawdown $27,072 · netto/DD 9.44 · anni in perdita 2 su 14 · notti a mercato 2.61 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $90,683 su 107 trade, drawdown $16,837.</para>
...
/// </summary>
public sealed class PT5DAV_GC_LFH_003_240 : Pt5DavHighLowFaderEngine
{
    public override string Name => "PT5DAV_GC_LFH_003_240";

    public override string Description => "LF_HL GC 4h, ricerca PT5DAV GC-4H-LFHL-8e771a";
