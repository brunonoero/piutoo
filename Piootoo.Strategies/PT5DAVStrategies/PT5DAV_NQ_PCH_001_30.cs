...
/// <summary>
/// <b>PT5DAV_NQ_PCH_001_30</b> — PC su NQ 30m, codice della ricerca <c>NQ-30M-PC-b611a0</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 1826 trade, netto $775,208; broker (27/08/2025 → 09/09/2026)
/// 162 trade, netto $38,002. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/NQ-30M-PC-b611a0.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $775,208 su 1826 trade · $425 a trade · drawdown $80,799 · netto/DD 9.59 · anni in perdita 3 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $170,630 su 1826 trade, drawdown $50,894.</para>
...
/// <para>Solo LONG</para>
/// <para>· deve essere VERO — direzionale 47: 'close &gt; O_d0 * 0.99'</para>
/// <para>Solo SHORT</para>
/// <para>· deve essere VERO — direzionale 47: 'close &lt; O_d0 * 1.01'</para>
...
/// </summary>
public sealed class PT5DAV_NQ_PCH_001_30 : Pt5DavPriceChannelEngine
{
    public override string Name => "PT5DAV_NQ_PCH_001_30";

    public override string Description => "PC NQ 30m, ricerca PT5DAV NQ-30M-PC-b611a0";

    public override string Symbol => "@NQ";

    public override int TimeframeMinutes => 30;

    public override string ResearchCode => "NQ-30M-PC-b611a0";

    public PT5DAV_NQ_PCH_001_30()
    {
