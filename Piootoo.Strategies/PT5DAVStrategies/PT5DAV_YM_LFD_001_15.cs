...
/// <summary>
/// <b>PT5DAV_YM_LFD_001_15</b> — LF su YM 15m, codice della ricerca <c>YM-15M-LF-8a2596</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 1221 trade, netto $164,473; broker (27/08/2025 → 09/09/2026)
/// 103 trade, netto $-4,812. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/YM-15M-LF-8a2596.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $164,473 su 1221 trade · $135 a trade · drawdown $26,031 · netto/DD 6.32 · anni in perdita 4 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $62,958 su 1221 trade, drawdown $12,898.</para>
...
/// <para>· Opera solo fra 10:00 e 23:59, CET: ordini emessi sulle barre che chiudono fra le 10:00 e le 23:59 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_YM_LFD_001_15 : Pt5DavPivotFaderEngine
{
    public override string Name => "PT5DAV_YM_LFD_001_15";

    public override string Description => "LF YM 15m, ricerca PT5DAV YM-15M-LF-8a2596";

    public override string Symbol => "@YM";

    public override int TimeframeMinutes => 15;

    public override string ResearchCode => "YM-15M-LF-8a2596";

    public PT5DAV_YM_LFD_001_15()
    {
        TradingWindow = ResearchWindow(10, -1); // start_hour 10, end_hour -1, verbatim
