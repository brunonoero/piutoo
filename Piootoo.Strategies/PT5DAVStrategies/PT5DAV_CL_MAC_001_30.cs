...
/// <summary>
/// <b>PT5DAV_CL_MAC_001_30</b> — MAC su CL 30m, codice della ricerca <c>CL-30M-MAC-dc3581</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 243 trade, netto $76,645; broker (27/08/2025 → 09/09/2026)
/// 20 trade, netto $1,411. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/CL-30M-MAC-dc3581.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $76,645 su 243 trade · $315 a trade · drawdown $10,367 · netto/DD 7.39 · anni in perdita 4 su 14 · notti a mercato 0.99 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $40,594 su 243 trade, drawdown $9,557.</para>
...
/// </summary>
public sealed class PT5DAV_CL_MAC_001_30 : Pt5DavMovingAverageCrossoverEngine
{
    public override string Name => "PT5DAV_CL_MAC_001_30";

    public override string Description => "MAC CL 30m, ricerca PT5DAV CL-30M-MAC-dc3581";

    public override string Symbol => "@CL";

    public override int TimeframeMinutes => 30;

    public override string ResearchCode => "CL-30M-MAC-dc3581";

    public PT5DAV_CL_MAC_001_30()
    {
