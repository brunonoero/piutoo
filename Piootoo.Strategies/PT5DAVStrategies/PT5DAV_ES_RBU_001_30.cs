...
/// <summary>
/// <b>PT5DAV_ES_RBU_001_30</b> — RBB_U su ES 30m, codice della ricerca <c>ES-30M-RBBU-b45540</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 2665 trade, netto $332,333; broker (27/08/2025 → 09/09/2026)
/// 200 trade, netto $28,864. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/ES-30M-RBBU-b45540.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $332,333 su 2665 trade · $125 a trade · drawdown $78,064 · netto/DD 4.26 · anni in perdita 2 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $87,692 su 2665 trade, drawdown $47,323.</para>
...
/// <para>· Opera solo fra 00:00 e 20:00, CET: ordini emessi sulle barre che chiudono fra le 00:00 e le 20:00 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_ES_RBU_001_30 : Pt5DavBollingerUnmirroredEngine
{
    public override string Name => "PT5DAV_ES_RBU_001_30";

    public override string Description => "RBB_U ES 30m, ricerca PT5DAV ES-30M-RBBU-b45540";

    public override string Symbol => "@ES";

    public override int TimeframeMinutes => 30;

    public override string ResearchCode => "ES-30M-RBBU-b45540";

    public PT5DAV_ES_RBU_001_30()
    {
        TradingWindow = ResearchWindow(-1, 20); // start_hour -1, end_hour 20, verbatim
