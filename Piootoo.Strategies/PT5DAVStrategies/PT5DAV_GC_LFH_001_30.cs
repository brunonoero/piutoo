...
/// <summary>
/// <b>PT5DAV_GC_LFH_001_30</b> — LF_HL su GC 30m, codice della ricerca <c>GC-30M-LFHL-3bcfa0</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 266 trade, netto $290,994; broker (27/08/2025 → 09/09/2026)
/// 40 trade, netto $7,476. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/GC-30M-LFHL-3bcfa0.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $290,994 su 266 trade · $1,094 a trade · drawdown $20,204 · netto/DD 14.40 · anni in perdita 2 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $102,811 su 266 trade, drawdown $13,356.</para>
...
/// </summary>
public sealed class PT5DAV_GC_LFH_001_30 : Pt5DavHighLowFaderEngine
{
    public override string Name => "PT5DAV_GC_LFH_001_30";

    public override string Description => "LF_HL GC 30m, ricerca PT5DAV GC-30M-LFHL-3bcfa0";

    public override string Symbol => "@GC";

    public override int TimeframeMinutes => 30;

    public override string ResearchCode => "GC-30M-LFHL-3bcfa0";

    public PT5DAV_GC_LFH_001_30()
    {
