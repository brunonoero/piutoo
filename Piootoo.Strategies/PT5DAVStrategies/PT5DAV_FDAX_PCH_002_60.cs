...
/// <summary>
/// <b>PT5DAV_FDAX_PCH_002_60</b> — PC su FDAX 1h, codice della ricerca <c>FDAX-1H-PC-22b63c</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 718 trade, netto $582,280; broker (27/08/2025 → 09/09/2026)
/// 58 trade, netto $22,292. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/FDAX-1H-PC-22b63c.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $582,280 su 718 trade · $811 a trade · drawdown $48,172 · netto/DD 12.09 · anni in perdita 0 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $227,515 su 718 trade, drawdown $26,535.</para>
...
/// <para>· deve essere FALSO — neutrale 30: '|O_d5-C_d1| &gt; 0.75 * (HH5-LL5)'</para>
/// <para>Solo LONG</para>
/// <para>· deve essere VERO — direzionale -27: 'H_d0 &lt; H_d1'</para>
/// <para>Solo SHORT</para>
/// <para>· deve essere VERO — direzionale -27: 'L_d0 &gt; L_d1'</para>
/// <para><b>Quando puo' operare</b></para>
/// <para>· Opera solo fra 09:00 e 18:00, CET: ordini emessi sulle barre che chiudono fra le 09:00 e le 18:00 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_FDAX_PCH_002_60 : Pt5DavPriceChannelEngine
{
    public override string Name => "PT5DAV_FDAX_PCH_002_60";

    public override string Description => "PC FDAX 1h, ricerca PT5DAV FDAX-1H-PC-22b63c";

    public override string Symbol => "@FDAX";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "FDAX-1H-PC-22b63c";

    public PT5DAV_FDAX_PCH_002_60()
    {
        TradingWindow = ResearchWindow(9, 18);  // start_hour 9, end_hour 18, verbatim
