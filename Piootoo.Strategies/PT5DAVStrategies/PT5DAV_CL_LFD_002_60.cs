...
/// <summary>
/// <b>PT5DAV_CL_LFD_002_60</b> — LF su CL 1h, codice della ricerca <c>CL-1H-LF-5c157f</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 52 trade, netto $182,146; broker (27/08/2025 → 09/09/2026)
/// 13 trade, netto $-14,743. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/CL-1H-LF-5c157f.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $182,146 su 52 trade · $3,503 a trade · drawdown $20,131 · netto/DD 9.05 · anni in perdita 3 su 14 · notti a mercato 3.60 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $50,242 su 52 trade, drawdown $16,930.</para>
...
/// <para>· livello LONG = S1 − 0.15 × ATR50; livello SHORT = R1 + 0.15 × ATR50</para>
...
/// <para>· Opera solo fra 09:00 e 13:00, CET: ordini emessi sulle barre che chiudono fra le 09:00 e le 13:00 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_CL_LFD_002_60 : Pt5DavPivotFaderEngine
{
    public override string Name => "PT5DAV_CL_LFD_002_60";

    public override string Description => "LF CL 1h, ricerca PT5DAV CL-1H-LF-5c157f";

    public override string Symbol => "@CL";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "CL-1H-LF-5c157f";

    public PT5DAV_CL_LFD_002_60()
    {
        TradingWindow = ResearchWindow(9, 13);  // start_hour 9, end_hour 13, verbatim
