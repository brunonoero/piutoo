...
/// <summary>
/// <b>PT5DAV_NQ_LFD_003_60</b> — LF su NQ 1h, codice della ricerca <c>NQ-1H-LF-e44570</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 83 trade, netto $327,450; broker (27/08/2025 → 09/09/2026)
/// 14 trade, netto $-39,048. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/NQ-1H-LF-e44570.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $327,450 su 83 trade · $3,945 a trade · drawdown $59,008 · netto/DD 5.55 · anni in perdita 3 su 12 · notti a mercato 3.88 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $170,108 su 83 trade, drawdown $18,752.</para>
...
/// <para>· livello LONG = S1 − 0.30 × ATR50; livello SHORT = R1 + 0.30 × ATR50</para>
...
/// <para>· deve essere VERO — neutrale 35: '(H_d0-L_d0) &gt; L_d0 * 0.02'</para>
/// <para><b>Quando puo' operare</b></para>
/// <para>· Opera solo fra 09:00 e 19:00, CET: ordini emessi sulle barre che chiudono fra le 09:00 e le 19:00 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_NQ_LFD_003_60 : Pt5DavPivotFaderEngine
{
    public override string Name => "PT5DAV_NQ_LFD_003_60";

    public override string Description => "LF NQ 1h, ricerca PT5DAV NQ-1H-LF-e44570";

    public override string Symbol => "@NQ";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "NQ-1H-LF-e44570";

    public PT5DAV_NQ_LFD_003_60()
    {
        TradingWindow = ResearchWindow(9, 19);  // start_hour 9, end_hour 19, verbatim
        LevelShiftAtr = 0.3m;                   // level_shift_atr
        NeutralYes = 35;                        // ptn_neut_yes
