...
/// <summary>
/// <b>PT5DAV_BP_RBM_001_15</b> — RBB_M su BP 15m, codice della ricerca <c>BP-15M-RBBM-8c9611</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 588 trade, netto $26,578; broker (27/08/2025 → 09/09/2026)
/// 38 trade, netto $2,922. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/BP-15M-RBBM-8c9611.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $26,578 su 588 trade · $45 a trade · drawdown $5,498 · netto/DD 4.83 · anni in perdita 3 su 14 · notti a mercato 0.90 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $23,474 su 588 trade, drawdown $6,388.</para>
...
/// </summary>
public sealed class PT5DAV_BP_RBM_001_15 : Pt5DavBollingerMirroredEngine
{
    public override string Name => "PT5DAV_BP_RBM_001_15";

    public override string Description => "RBB_M BP 15m, ricerca PT5DAV BP-15M-RBBM-8c9611";

    public override string Symbol => "@BP";

    public override int TimeframeMinutes => 15;

    public override string ResearchCode => "BP-15M-RBBM-8c9611";

    public PT5DAV_BP_RBM_001_15()
    {
