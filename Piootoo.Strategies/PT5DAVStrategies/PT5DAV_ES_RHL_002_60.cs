...
/// <summary>
/// <b>PT5DAV_ES_RHL_002_60</b> — RHL su ES 1h, codice della ricerca <c>ES-1H-RHL-e0bf51</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 173 trade, netto $316,797; broker (27/08/2025 → 09/09/2026)
/// 7 trade, netto $14,781. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/ES-1H-RHL-e0bf51.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $316,797 su 173 trade · $1,831 a trade · drawdown $32,623 · netto/DD 9.71 · anni in perdita 1 su 14 · notti a mercato 1.77 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $121,371 su 173 trade, drawdown $16,446.</para>
...
/// </summary>
public sealed class PT5DAV_ES_RHL_002_60 : Pt5DavRhlEngine
{
    public override string Name => "PT5DAV_ES_RHL_002_60";

    public override string Description => "RHL ES 1h, ricerca PT5DAV ES-1H-RHL-e0bf51";

    public override string Symbol => "@ES";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "ES-1H-RHL-e0bf51";

    public PT5DAV_ES_RHL_002_60()
    {
