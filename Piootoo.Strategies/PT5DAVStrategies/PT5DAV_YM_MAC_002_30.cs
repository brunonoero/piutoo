...
/// <summary>
/// <b>PT5DAV_YM_MAC_002_30</b> — MAC su YM 30m, codice della ricerca <c>YM-30M-MAC-5cdc3b</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 421 trade, netto $75,217; broker (27/08/2025 → 09/09/2026)
/// 33 trade, netto $-14,982. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/YM-30M-MAC-5cdc3b.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $75,217 su 421 trade · $179 a trade · drawdown $19,225 · netto/DD 3.91 · anni in perdita 4 su 14 · notti a mercato 1.29 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $35,601 su 421 trade, drawdown $15,158.</para>
/// <para><b>Incrocio di medie mobili 16/50</b></para>
/// <para>· Due medie mobili semplici sulla close: veloce a 16 barre, lenta a 50 barre.</para>
...
/// </summary>
public sealed class PT5DAV_YM_MAC_002_30 : Pt5DavMovingAverageCrossoverEngine
{
    public override string Name => "PT5DAV_YM_MAC_002_30";

    public override string Description => "MAC YM 30m, ricerca PT5DAV YM-30M-MAC-5cdc3b";

    public override string Symbol => "@YM";

    public override int TimeframeMinutes => 30;

    public override string ResearchCode => "YM-30M-MAC-5cdc3b";

    public PT5DAV_YM_MAC_002_30()
    {
