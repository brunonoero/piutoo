...
/// <summary>
/// <b>PT5DAV_YM_PCH_003_60</b> — PC su YM 1h, codice della ricerca <c>YM-1H-PC-70ea3b</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 1529 trade, netto $153,992; broker (27/08/2025 → 09/09/2026)
/// 110 trade, netto $2,290. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/YM-1H-PC-70ea3b.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $153,992 su 1529 trade · $101 a trade · drawdown $34,423 · netto/DD 4.47 · anni in perdita 1 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $65,877 su 1529 trade, drawdown $18,029.</para>
...
/// <para>· Opera solo fra 11:00 e 17:00, CET: ordini emessi sulle barre che chiudono fra le 11:00 e le 17:00 (estremi inclusi), cioè attivi da quell'ora in poi</para>
...
/// </summary>
public sealed class PT5DAV_YM_PCH_003_60 : Pt5DavPriceChannelEngine
{
    public override string Name => "PT5DAV_YM_PCH_003_60";

    public override string Description => "PC YM 1h, ricerca PT5DAV YM-1H-PC-70ea3b";

    public override string Symbol => "@YM";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "YM-1H-PC-70ea3b";

    public PT5DAV_YM_PCH_003_60()
    {
        TradingWindow = ResearchWindow(11, 17); // start_hour 11, end_hour 17, verbatim
