...
/// <summary>
/// <b>PT5DAV_GC_RHL_001_30</b> — RHL su GC 30m, codice della ricerca <c>GC-30M-RHL-20b00f</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 958 trade, netto $411,029; broker (27/08/2025 → 09/09/2026)
/// 60 trade, netto $-27,734. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/GC-30M-RHL-20b00f.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $411,029 su 958 trade · $429 a trade · drawdown $43,522 · netto/DD 9.44 · anni in perdita 1 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $133,498 su 958 trade, drawdown $14,095.</para>
...
/// </summary>
public sealed class PT5DAV_GC_RHL_001_30 : Pt5DavRhlEngine
{
    public override string Name => "PT5DAV_GC_RHL_001_30";

    public override string Description => "RHL GC 30m, ricerca PT5DAV GC-30M-RHL-20b00f";

    public override string Symbol => "@GC";

    public override int TimeframeMinutes => 30;

    public override string ResearchCode => "GC-30M-RHL-20b00f";

    public PT5DAV_GC_RHL_001_30()
    {
