...
/// <summary>
/// <b>PT5DAV_ES_PCH_001_15</b> — PC su ES 15m, codice della ricerca <c>ES-15M-PC-2a3e7d</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 878 trade, netto $354,429; broker (27/08/2025 → 09/09/2026)
/// 72 trade, netto $-23,359. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/ES-15M-PC-2a3e7d.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $354,429 su 878 trade · $404 a trade · drawdown $43,945 · netto/DD 8.07 · anni in perdita 1 su 14 · notti a mercato 0.00 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $109,015 su 878 trade, drawdown $33,200.</para>
...
/// </summary>
public sealed class PT5DAV_ES_PCH_001_15 : Pt5DavPriceChannelEngine
{
    public override string Name => "PT5DAV_ES_PCH_001_15";

    public override string Description => "PC ES 15m, ricerca PT5DAV ES-15M-PC-2a3e7d";

    public override string Symbol => "@ES";

    public override int TimeframeMinutes => 15;

    public override string ResearchCode => "ES-15M-PC-2a3e7d";

    public PT5DAV_ES_PCH_001_15()
    {
