...
/// <summary>
/// <b>PT5DAV_NQ_MAC_001_15</b> — MAC su NQ 15m, codice della ricerca <c>NQ-15M-MAC-5368bc</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 1243 trade, netto $175,350; broker (27/08/2025 → 09/09/2026)
/// 79 trade, netto $-16,191. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/NQ-15M-MAC-5368bc.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $175,350 su 1243 trade · $141 a trade · drawdown $59,511 · netto/DD 2.95 · anni in perdita 3 su 14 · notti a mercato 0.43 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $76,994 su 1243 trade, drawdown $33,380.</para>
...
/// <para>· Filtro gradiente: su 2 barre la veloce deve essersi mossa, in valore assoluto, almeno 1.6 volte quanto la lenta nello stesso tratto.</para>
...
/// </summary>
public sealed class PT5DAV_NQ_MAC_001_15 : Pt5DavMovingAverageCrossoverEngine
{
    public override string Name => "PT5DAV_NQ_MAC_001_15";

    public override string Description => "MAC NQ 15m, ricerca PT5DAV NQ-15M-MAC-5368bc";

    public override string Symbol => "@NQ";

    public override int TimeframeMinutes => 15;

    public override string ResearchCode => "NQ-15M-MAC-5368bc";

    public PT5DAV_NQ_MAC_001_15()
    {
