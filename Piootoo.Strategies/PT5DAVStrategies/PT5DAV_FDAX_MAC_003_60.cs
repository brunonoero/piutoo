...
/// <summary>
/// <b>PT5DAV_FDAX_MAC_003_60</b> — MAC su FDAX 1h, codice della ricerca <c>FDAX-1H-MAC-ba5e30</c>
/// (consegna PT5DAV v5.0 del 23/09/2026, <c>piootoo-repository/PT5DAV/</c>).
///
/// <para>Parametri riportati verbatim da <c>strategie_224.csv</c>; le regole comuni (ATR50, sessione
/// della ricerca, orari del CFD) stanno in <see cref="Pt5DavEngineBase"/>. Numeri della ricerca sul
/// CFD: storia 313 trade, netto $206,643; broker (27/08/2025 → 09/09/2026)
/// 28 trade, netto $-38,263. Trade di riferimento:
/// <c>PT5DAV/trades_per_strategia/FDAX-1H-MAC-ba5e30.csv</c>.</para>
///
...
/// <para>Tutta la storia sul CFD (10/01/2012 → 30/05/2025; ogni trade riportato al prezzo di oggi, con spread, commissione e swap): netto $206,643 su 313 trade · $660 a trade · drawdown $43,027 · netto/DD 4.80 · anni in perdita 2 su 14 · notti a mercato 0.96 a trade.</para>
/// <para>Sul future (prezzi di allora, costi del future): $104,540 su 313 trade, drawdown $23,547.</para>
...
/// </summary>
public sealed class PT5DAV_FDAX_MAC_003_60 : Pt5DavMovingAverageCrossoverEngine
{
    public override string Name => "PT5DAV_FDAX_MAC_003_60";

    public override string Description => "MAC FDAX 1h, ricerca PT5DAV FDAX-1H-MAC-ba5e30";

    public override string Symbol => "@FDAX";

    public override int TimeframeMinutes => 60;

    public override string ResearchCode => "FDAX-1H-MAC-ba5e30";

    public PT5DAV_FDAX_MAC_003_60()
    {
