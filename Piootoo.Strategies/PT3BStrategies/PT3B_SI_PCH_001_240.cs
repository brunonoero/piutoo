...
/// <summary>
/// <b>Contenitore di ricerca, non una strategia da eseguire.</b> Price Channel su XAGUSD a 4 ore
...
/// XAGUSD, feed FTMO raccolto il 23/09/2026. Lo spread vale il 22,2% del range medio della
/// barra da 4 ore, contro l'1,9% del DAX e il 5,9% di EU50.</para>
///
/// <para><b>Il denaro.</b> argento (COMEX SI), 5.000 once, 5.000 dollari per dollaro. Il range medio della barra da 4 ore e'
/// 0,252 dollari, 1.261 dollari nel 2022-2024: la griglia di stop e target e' quella del FDAX riscalata su quel range.</para>
///
/// <para><b>Non va in nessun piano</b>: vedi <see cref="EasyEngineBase.IsResearchContainer"/>.</para>
/// </summary>
public sealed class PT3B_SI_PCH_001_240 : PriceChannelEngine
{
    public override string Name => "PT3B_SI_PCH_001_240";

    public override string Description =>
        "PC XAGUSD 4 ore, motore nudo: contenitore per la griglia grossa, NON una strategia da eseguire";
    ...
    public PT3B_SI_PCH_001_240()
    {
        ...
        ChannelBars = 20;
        OffsetTicks = 0;
        TickSize = 0.005m;  // tick del future
        Direction = 0;
        DvolMin = 0m;
        SkipDay = -1;
        ...
        StopMoney = 3550;  // dollari per contratto, al centro della griglia
        ProfitMoney = 3200;
        TrailingStopMoney = 0;
        BreakEvenMoney = 0;
        MaxBars = 0;
