...
/// <summary>
/// <b>Contenitore di ricerca, non una strategia da eseguire.</b> Price Channel su JP225 a 4 ore
...
/// JP225, feed FTMO raccolto il 23/09/2026. Lo spread vale il 4,5% del range medio della
/// barra da 4 ore, contro l'1,9% del DAX e il 5,9% di EU50.</para>
///
/// <para><b>Il denaro.</b> Nikkei 225 in yen (CME NIY), 500 yen per punto. Il range medio della barra da 4 ore e'
/// 224 punti, 112.000 yen nel 2022-2024: la griglia di stop e target e' quella del FDAX riscalata su quel range.</para>
///
/// <para><b>Non va in nessun piano</b>: vedi <see cref="EasyEngineBase.IsResearchContainer"/>.</para>
/// </summary>
public sealed class PT3B_NIY_PCH_001_240 : PriceChannelEngine
{
    public override string Name => "PT3B_NIY_PCH_001_240";

    public override string Description =>
        "PC JP225 4 ore, motore nudo: contenitore per la griglia grossa, NON una strategia da eseguire";

    public override string Symbol => "@NIY";
    ...
    public PT3B_NIY_PCH_001_240()
    {
        ...
        StopMoney = 320000;  // yen per contratto, al centro della griglia
        ProfitMoney = 280000;
        TrailingStopMoney = 0;
        BreakEvenMoney = 0;
        MaxBars = 0;
