...
/// <summary>
/// <b>Contenitore di ricerca, non una strategia da eseguire.</b> Price Channel su FRA40 a 4 ore
...
/// FRA40, feed FTMO raccolto il 23/09/2026. Lo spread vale il 3,3% del range medio della
/// barra da 4 ore, contro l'1,9% del DAX e il 5,9% di EU50.</para>
///
/// <para><b>Il denaro.</b> CAC 40 (Euronext), 10 euro per punto. Il range medio della barra da 4 ore e'
/// 48,5 punti, 485 euro nel 2022-2024: la griglia di stop e target e' quella del FDAX riscalata su quel range.</para>
///
/// <para><b>Non va in nessun piano</b>: vedi <see cref="EasyEngineBase.IsResearchContainer"/>.</para>
/// </summary>
public sealed class PT3B_FCE_PCH_001_240 : PriceChannelEngine
{
    public override string Name => "PT3B_FCE_PCH_001_240";

    public override string Description =>
        "PC FRA40 4 ore, motore nudo: contenitore per la griglia grossa, NON una strategia da eseguire";

    public override string Symbol => "@FCE";
    ...
    public PT3B_FCE_PCH_001_240()
    {
        ...
        StopMoney = 1350;  // euro per contratto, al centro della griglia
        ProfitMoney = 1250;
        TrailingStopMoney = 0;
        BreakEvenMoney = 0;
        MaxBars = 0;
