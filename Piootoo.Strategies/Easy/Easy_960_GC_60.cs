...
/// <summary>
/// Strategia EasyLanguage convertita: TOP_UA_960
/// Works using 30-minute bars
/// </summary>
public class Easy_960_GC_60 : StatelessEasyStrategyBase
{
    // INPUTS
    private int _titanExportMode = 0;
    private int _myPtnLY = 31;
    private int _myPtnSY = 14;
    private int _myPtnLN = 34;
    private int _myPtnSN = 30;
    private int _myLEbar = 21;
    private int _myLXbar = 8;
    private int _mySEbar = 8;
    private int _mySXbar = 16;
    private int _myNotLEDay = 3;
    private int _myNotSEDay = 0;
    ...
    private string _name = "TOP_UA_960";
    private string _description = "Works using 30-minute bars";
