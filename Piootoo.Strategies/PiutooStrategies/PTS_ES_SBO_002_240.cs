...
/// <summary>
/// PTS_ES_SBO_002_240 - BO su ES a 4 ore, <b>S12</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S12.</b> E' l'identificativo con cui questa strategia compare
...
/// <list type="bullet">
/// <item><description>LONG: stop buy sul <b>massimo delle ultime 3 sessioni complete</b> + 2 tick</description></item>
/// <item><description>SHORT: stop sell sul <b>minimo delle ultime 3 sessioni complete</b> - 2 tick</description></item>
/// <item><description><c>n_sess = 3</c>, <c>lev_include_sess0 = 0</c>, <c>breakout_offset_ticks = 2</c>: l'offset e' esattamente <c>2 x tick</c>, senza tick impliciti</description></item>
/// </list>
///
...
/// <item><description>deve essere FALSO - direzionale <c>33</c></description></item>
/// </list>
///
...
/// <item><description>Take profit: <b>$10.000</b> = <b>200.00 pt</b></description></item>
...
/// <item><term>Atteso per trade</term><description>$811</description></item>
/// <item><term>Fuori campione</term><description>$87.321 su 51 trade</description></item>
/// <item><term>Drawdown</term><description>$25.308</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260824_1847/consegna/trades/fam01_BO.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_ES_SBO_002_240 : SessionBreakoutEngine
{
    public override string Name => "PTS_ES_SBO_002_240";
    public override string Description =>
        "BO ES 4 ore: S12 del dossier, run run_20260824_1847, finestra 14:00-09:00 CET, multiday";
    public override string Symbol => "@ES";
    public override int TimeframeMinutes => 240;

    public PTS_ES_SBO_002_240()
    {
