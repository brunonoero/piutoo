...
/// <summary>
/// PTS_NQ_SBO_005_1440 - BO su NQ a giornaliero, <b>S02</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S02.</b> E' l'identificativo con cui questa strategia compare
...
/// <list type="bullet">
/// <item><description>LONG: stop buy sul <b>massimo delle ultime 1 sessioni complete</b></description></item>
/// <item><description>SHORT: stop sell sul <b>minimo delle ultime 1 sessioni complete</b></description></item>
/// <item><description><c>n_sess = 1</c>, <c>lev_include_sess0 = 0</c>, <c>breakout_offset_ticks = 0</c>: l'offset e' esattamente <c>0 x tick</c>, senza tick impliciti</description></item>
/// </list>
///
...
/// <item><description>deve essere FALSO - neutrale <c>28</c></description></item>
/// <item><description>deve essere VERO - direzionale <c>-3</c></description></item>
/// <item><description>deve essere FALSO - direzionale <c>6</c></description></item>
/// </list>
///
...
/// <item><description>Uscita a tempo dopo <b>10 barre</b></description></item>
/// </list>
///
...
/// <item><term>Atteso per trade</term><description>$2.720</description></item>
/// <item><term>Fuori campione</term><description>$129.980 su 45 trade</description></item>
/// <item><term>Drawdown</term><description>$29.444</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260822_0736/consegna/trades/fam02_BO.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
///
/// <para>ATTENZIONE: <b>non mettere su conti diversi</b> insieme a <c>day fam02-3</c> del
/// dossier: emettono gli stessi ordini di entrata, e due sistemi che mandano gli stessi
/// ordini sono copy trading.</para>
/// </summary>
public sealed class PTS_NQ_SBO_005_1440 : SessionBreakoutEngine
{
    public override string Name => "PTS_NQ_SBO_005_1440";
    public override string Description =>
        "BO NQ giornaliero: S02 del dossier, run run_20260822_0736, finestra 24h, multiday";
    public override string Symbol => "@NQ";
    public override int TimeframeMinutes => 1440;

    public PTS_NQ_SBO_005_1440()
    {
        ...
        NeutralNo = 28;       // ptn_neut_no
        DirectionalYes = -3;  // ptn_dir_yes (il segno lo applica il motore per verso)
        DirectionalNo = 6;   // ptn_dir_no
