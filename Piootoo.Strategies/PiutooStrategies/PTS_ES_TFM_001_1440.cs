...
/// <summary>
/// PTS_ES_TFM_001_1440 - TF_M su ES a giornaliero, <b>S37</b> del dossier
...
/// <item><description>deve essere FALSO - direzionale <c>51</c></description></item>
/// </list>
///
...
/// <item><term>Atteso per trade</term><description>$223</description></item>
/// <item><term>Fuori campione</term><description>$83.746 su 76 trade</description></item>
/// <item><term>Drawdown</term><description>$13.541</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260822_1249/consegna/trades/fam02_TF_M.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
///
/// <para>ATTENZIONE: <b>non mettere su conti diversi</b> insieme a <c>day fam02-2, day fam02-3</c> del
/// dossier: emettono gli stessi ordini di entrata, e due sistemi che mandano gli stessi
/// ordini sono copy trading.</para>
/// </summary>
public sealed class PTS_ES_TFM_001_1440 : TfMirroredEngine
{
    public override string Name => "PTS_ES_TFM_001_1440";
    public override string Description =>
        "TF_M ES giornaliero: S37 del dossier, run run_20260822_1249, finestra 24h, multiday";
    public override string Symbol => "@ES";
    public override int TimeframeMinutes => 1440;

    public PTS_ES_TFM_001_1440()
    {
