...
/// <summary>
/// PTS_NQ_TFM_010_60 — TF_M su NQ a 60 minuti, famiglia 02 della consegna
/// <c>run_20260820_0856</c> (S02 del <i>vecchio</i> dossier NQ 1h).
///
/// <para><b>Codice sorgente: S22.</b> E' l'identificativo con cui questa strategia
...
/// <c>run_20260820_0856/consegna/trades/fam02_TF_M.csv</c>.</para>
///
...
/// <item><description>deve essere FALSO — neutrale 11: <c>|O_d5-C_d1| &lt; 0.5 * (H_d5-L_d1)</c></description></item>
/// </list>
...
/// <list type="bullet">
/// <item><description>Opera solo fra 00:00 e 17:00, ora dei dati (CET)</description></item>
...
/// <item><description>Uscita a tempo dopo 48 barre (2.0 giorni di calendario)</description></item>
/// </list>
///
...
/// <item><term>Atteso per trade</term><description>$422.4</description></item>
/// <item><term>Out-of-sample</term><description>$49,592 su 112 trade &#183; drawdown $20,581 &#183; profit factor 1.34 &#183; $443 per trade.</description></item>
/// <item><term>Plateau minimo</term><description>0.78</description></item>
/// <item><term>Efficienza Walk-Forward</term><description>0.95</description></item>
/// <item><term>Monte Carlo drawdown p95</term><description>$42,791</description></item>
/// </list>
///
/// <para><b>Verifica del porting:</b> lista trade di riferimento
/// <c>run-engine/run-06-gosto/consegna/trades/fam02_TF_M.csv</c> (456 trade totali, 112 OOS,
/// 2012-01-10 → 2025-05-15).</para>
/// </summary>
public sealed class PTS_NQ_TFM_010_60 : TfMirroredEngine
{
    public override string Name => "PTS_NQ_TFM_010_60";
    public override string Description =>
        "TF_M NQ 60m: famiglia 02 run 20260820, finestra 00:00–17:00 CET, multiday";
    public override string Symbol => "@NQ";
    public override int TimeframeMinutes => 60;

    public PTS_NQ_TFM_010_60()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(0, 17);
        ...
        ProfitMoney = 5000; // take_profit, $ per contratto = 250.00 pt
        MaxBars = 48;       // max_bars
    }
