...
/// <summary>
/// PTS_GC_TFM_001_240 - TF_M su GC a 4 ore, <b>S15</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S15.</b> E' l'identificativo con cui questa strategia compare
...
/// <item><description>deve essere FALSO - neutrale <c>18</c></description></item>
...
/// <list type="bullet">
/// <item><description>Opera solo fra <b>10:00 e 13:00</b>, ora della ricerca (CET)</description></item>
...
/// <list type="bullet">
/// <item><description>Stop loss: <b>$5.000</b> per contratto = <b>50.00 pt</b></description></item>
/// <item><description>Take profit: <b>$7.500</b> = <b>75.00 pt</b></description></item>
...
/// <item><term>Atteso per trade</term><description>$642</description></item>
/// <item><term>Fuori campione</term><description>$64.398 su 62 trade</description></item>
/// <item><term>Drawdown</term><description>$19.692</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260824_1935/consegna/trades/fam01_TF_M.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_GC_TFM_001_240 : TfMirroredEngine
{
    public override string Name => "PTS_GC_TFM_001_240";
    public override string Description =>
        "TF_M GC 4 ore: S15 del dossier, run run_20260824_1935, finestra 10:00-13:00 CET, multiday";
    public override string Symbol => "@GC";
    public override int TimeframeMinutes => 240;

    public PTS_GC_TFM_001_240()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(10, 13);   // start_hour 10, end_hour 13
        ...
        StopMoney = 5000;        // stop_loss, $ per contratto = 50.00 pt
