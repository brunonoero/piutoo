...
/// <summary>
/// PTS_CL_MAC_001_30 - MAC su CL a 30 minuti, <b>S40</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S40.</b> E' l'identificativo con cui questa strategia compare
/// nel dossier: e' da li' che si risale a condizioni, filtri e parametri per un controllo,
/// senza riaprire i CSV a tentativi. La riga di ricerca e' <c>run_20260822_0403</c>, famiglia
...
/// <list type="bullet">
/// <item><description>Due medie mobili <b>semplici</b> sulla close: veloce a <b>20 barre</b>, lenta a <b>50 barre</b></description></item>
/// <item><description>Segnale LONG: la veloce incrocia <b>sopra</b> la lenta; SHORT: incrocia <b>sotto</b></description></item>
/// <item><description>Filtro gradiente: su 5 barre la veloce deve essersi mossa, in valore assoluto, almeno <b>2 volte</b> quanto la lenta nello stesso tratto</description></item>
...
/// <list type="bullet">
/// <item><description>Stop loss: <b>$1.000</b> per contratto = <b>1.00 pt</b></description></item>
...
/// </list>
///
/// <para><b>Contratto di riferimento:</b> CL, $1.000 per punto, tick 0,01.</para>
///
/// <para><b>Metriche di validazione storica - non sono garanzie di rendimento.</b></para>
/// <list type="table">
/// <listheader><term>Metrica</term><description>Valore</description></listheader>
/// <item><term>Atteso per trade</term><description>$199</description></item>
/// <item><term>Fuori campione</term><description>$39.344 su 186 trade</description></item>
/// <item><term>Drawdown</term><description>$17.164</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260822_0403/consegna/trades/fam01_MAC.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_CL_MAC_001_30 : MovingAverageCrossoverEngine
{
    public override string Name => "PTS_CL_MAC_001_30";
    public override string Description =>
        "MAC CL 30 minuti: S40 del dossier, run run_20260822_0403, finestra 24h, multiday";
    public override string Symbol => "@CL";
    public override int TimeframeMinutes => 30;

    public PTS_CL_MAC_001_30()
    {
        ...
        FastPeriod = 20;                // media veloce
        SlowPeriod = 50;               // media lenta
        ...
        GradientPeriod = 5;            // barre del filtro gradiente
        ...
        StopMoney = 1000;        // stop_loss, $ per contratto = 1.00 pt
