...
/// <summary>
/// PTS_NQ_TFM_015_240 - TF_M su NQ a 4 ore, <b>S13</b> del dossier
...
/// <list type="bullet">
/// <item><description>Opera solo fra <b>18:00 e 05:00</b> (a cavallo della mezzanotte), ora della ricerca (CET)</description></item>
...
/// <item><term>Atteso per trade</term><description>$781</description></item>
/// <item><term>Fuori campione</term><description>$114.096 su 146 trade</description></item>
/// <item><term>Drawdown</term><description>$25.482</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260824_1642/consegna/trades/fam02_TF_M.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
///
/// <para>ATTENZIONE: <b>non mettere su conti diversi</b> insieme a <c>4h fam02-2, 4h fam02-3</c> del
/// dossier: emettono gli stessi ordini di entrata, e due sistemi che mandano gli stessi
/// ordini sono copy trading.</para>
/// </summary>
public sealed class PTS_NQ_TFM_015_240 : TfMirroredEngine
{
    public override string Name => "PTS_NQ_TFM_015_240";
    public override string Description =>
        "TF_M NQ 4 ore: S13 del dossier, run run_20260824_1642, finestra 18:00-05:00 CET, multiday";
    public override string Symbol => "@NQ";
    public override int TimeframeMinutes => 240;

    public PTS_NQ_TFM_015_240()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(18, 5);   // start_hour 18, end_hour 5
