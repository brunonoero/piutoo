...
/// <summary>
/// PTS_FDAX_TFU_002_1440 - TF_U su FDAX a 1 giorno, <b>S09</b> del dossier
/// <c>run-engine/run-08-settembre/DOSSIER_PANIERE (1).md</c>.
///
/// <para><b>Codice sorgente: S09.</b> E' l'identificativo con cui questa strategia compare
...
/// <item><description>SHORT deve essere VERO - fast <c>11</c>: <c>|O_d5-C_d1| &lt; 0.5 * (H_d5-L_d1)</c></description></item>
/// <item><description>SHORT deve essere FALSO - fast <c>57</c>: <c>H_d0 &gt; L_d0 * (1 + 0.02)</c></description></item>
/// </list>
///
...
/// <item><term>Atteso per trade</term><description>$1.076</description></item>
/// <item><term>Fuori campione</term><description>$271.267 su 252 trade</description></item>
/// <item><term>Drawdown</term><description>$22.147</description></item>
/// </list>
///
...
///
/// <para>ATTENZIONE: <b>non mettere su conti diversi</b> insieme a <c>day fam01-3</c>,
/// <c>day fam01-4</c>, <c>day fam01-5</c> del dossier: emettono gli stessi ordini di entrata, e
/// due sistemi che mandano gli stessi ordini sono copy trading.</para>
/// </summary>
public sealed class PTS_FDAX_TFU_002_1440 : TfUnmirroredEngine
{
    public override string Name => "PTS_FDAX_TFU_002_1440";
    public override string Description =>
        "TF_U FDAX day: S09 del dossier, run run_20260825_1615, finestra 24h, multiday";
    ...
    public PTS_FDAX_TFU_002_1440()
    {
        ...
        FastYesShort = 11;    // ptn_fast_yes_short
        FastNoShort = 57;     // ptn_fast_no_short
