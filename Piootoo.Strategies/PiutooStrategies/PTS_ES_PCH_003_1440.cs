...
/// <summary>
/// PTS_ES_PCH_003_1440 - PC su ES a giornaliero, <b>S26</b> del dossier
...
/// <item><description>deve essere FALSO - neutrale <c>48</c></description></item>
/// <item><description>deve essere VERO - direzionale <c>52</c> <i>(sentinella: nessun filtro)</i></description></item>
/// <item><description>deve essere FALSO - direzionale <c>44</c></description></item>
/// </list>
///
...
/// <item><term>Atteso per trade</term><description>$306</description></item>
/// <item><term>Fuori campione</term><description>$50.510 su 57 trade</description></item>
/// <item><term>Drawdown</term><description>$12.438</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260822_1249/consegna/trades/fam01_PC.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
///
/// <para>ATTENZIONE: <b>non mettere su conti diversi</b> insieme a <c>day fam01-2</c> del
/// dossier: emettono gli stessi ordini di entrata, e due sistemi che mandano gli stessi
/// ordini sono copy trading.</para>
/// </summary>
public sealed class PTS_ES_PCH_003_1440 : PriceChannelEngine
{
    public override string Name => "PTS_ES_PCH_003_1440";
    public override string Description =>
        "PC ES giornaliero: S26 del dossier, run run_20260822_1249, finestra 24h, multiday";
    public override string Symbol => "@ES";
    public override int TimeframeMinutes => 1440;

    public PTS_ES_PCH_003_1440()
    {
