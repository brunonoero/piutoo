...
/// <summary>
/// PTS_BTC_TFU_001_60 - TF_U su BTC a 60 minuti, <b>S12</b> del dossier
...
/// <item><description>LONG deve essere FALSO - fast <c>52</c>: <c>(H_d1 &lt; H_d2) E (L_d1 &lt; L_d2)</c></description></item>
/// <item><description>SHORT deve essere VERO - fast <c>46</c>: <c>O_d0 - L_d0 &gt; (O_d1 - L_d1) * 3.0</c></description></item>
/// <item><description>SHORT deve essere FALSO - fast <c>65</c>: <c>H_d0 &lt; L_d0 * (1 + 0.025)</c></description></item>
/// </list>
///
...
/// <item><description>Take profit: <b>$7.500</b> = <b>1.500,00 pt</b></description></item>
...
/// <item><term>Atteso per trade</term><description>$943</description></item>
/// <item><term>Fuori campione</term><description>$188.415 su 169 trade</description></item>
/// <item><term>Drawdown</term><description>$22.565</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>BTC_1h/consegna/trades/fam01_TF_U.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
///
/// <para>ATTENZIONE: <b>non mettere su conti diversi</b> insieme a <c>1h fam01-2</c> del
/// dossier: emettono gli stessi ordini di entrata, e due sistemi che mandano gli stessi
/// ordini sono copy trading.</para>
/// </summary>
public sealed class PTS_BTC_TFU_001_60 : TfUnmirroredEngine
{
    public override string Name => "PTS_BTC_TFU_001_60";
    public override string Description =>
        "TF_U BTC 60m: S12 del dossier, run BTC_1h, finestra 04:00-03:00 CET, multiday";
    public override string Symbol => "@BTC";
    public override int TimeframeMinutes => 60;

    public PTS_BTC_TFU_001_60()
    {
        ...
        FastNoLong = 52;      // ptn_fast_no_long
        FastYesShort = 46;    // ptn_fast_yes_short
        FastNoShort = 65;     // ptn_fast_no_short
        ...
        ProfitMoney = 7500;      // take_profit, $ per contratto = 1.500,00 pt
