...
/// <summary>
/// PTS_NG_TFM_006_60 - TF_M su NG a 60 minuti, <b>S101</b> del dossier
/// <c>run-engine/run-08-settembre/DOSSIER_PANIERE (1).md</c>.
///
/// <para><b>Codice sorgente: S101.</b> E' l'identificativo con cui questa strategia compare
...
/// <c>fam03</c>, motore <c>TF_M</c>.</para>
///
...
/// neutrale <c>53</c> qui e' un pattern vero e proprio (<c>(H_d1-L_d1) &lt; (H_d2-L_d2)</c>), non
/// una sentinella - la sentinella direzionale ha lo stesso numero ma vive su un'altra libreria.</para>
/// <list type="bullet">
/// <item><description>deve essere VERO - neutrale <c>53</c>: <c>(H_d1-L_d1) &lt; (H_d2-L_d2)</c></description></item>
...
/// <item><description>deve essere FALSO - direzionale <c>7</c>: long <c>H_d0 - O_d0 &gt; (H_d1 - O_d1) * 2.5</c>, short <c>O_d0 - L_d0 &gt; (O_d1 - L_d1) * 2.5</c></description></item>
/// </list>
///
/// <para><b>Quando puo' operare.</b></para>
/// <list type="bullet">
/// <item><description>Opera solo fra <b>00:00 e 22:00</b>, ora della ricerca (CET): la finestra sta dentro la giornata</description></item>
...
/// <list type="bullet">
/// <item><description>Stop loss: <b>$1.250</b> per contratto = <b>0,12 pt</b></description></item>
...
/// <item><term>Atteso per trade</term><description>$90</description></item>
/// <item><term>Fuori campione</term><description>$54.782 su 293 trade</description></item>
/// <item><term>Drawdown</term><description>$23.166</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>NG_1h/consegna/trades/fam03_TF_M.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_NG_TFM_006_60 : TfMirroredEngine
{
    public override string Name => "PTS_NG_TFM_006_60";
    public override string Description =>
        "TF_M NG 60m: S101 del dossier, run NG_1h, finestra 00:00-22:00 CET, multiday";
    public override string Symbol => "@NG";
    public override int TimeframeMinutes => 60;

    public PTS_NG_TFM_006_60()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(0, 22);   // start_hour 0, end_hour 22

        NeutralYes = 53;      // ptn_neut_yes: pattern vero, non la sentinella
        ...
        DirectionalNo = 7;    // ptn_dir_no (il segno lo applica il motore per verso)
        SkipDay = -1;         // skip_day (convenzione pandas, 0 = lunedi')

        IntradayOnly = false;    // intraday_only = 0

        StopMoney = 1250;        // stop_loss, $ per contratto = 0,12 pt
