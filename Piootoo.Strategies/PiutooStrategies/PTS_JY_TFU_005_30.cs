...
/// <summary>
/// PTS_JY_TFU_005_30 - TF_U su JY a 30 minuti, <b>S49</b> del dossier
/// <c>run-engine/run-08-settembre/DOSSIER_PANIERE (1).md</c>.
///
/// <para><b>Codice sorgente: S49.</b> E' l'identificativo con cui questa strategia compare
...
/// <c>fam03</c>, motore <c>TF_U</c>.</para>
///
...
/// essere FALSO".</para>
/// <list type="bullet">
/// <item><description>LONG deve essere VERO - fast <c>139</c>: <c>(C_d1 &lt; O_d1) E (C_d2 &lt; O_d2)</c></description></item>
/// <item><description>LONG deve essere FALSO - fast <c>30</c>: <c>|O_d5-C_d1| &gt; 0.75 * (HH5-LL5)</c></description></item>
/// <item><description>SHORT deve essere VERO - fast <c>6</c>: <c>|O_d1-C_d1| &gt; 0.5 * (H_d1-L_d1)</c></description></item>
/// <item><description>SHORT deve essere FALSO - fast <c>111</c>: <c>(L_d1 &gt; L_d2) E (L_d1 &gt; L_d3) E (L_d1 &gt; L_d4)</c></description></item>
/// </list>
///
/// <para><b>Quando puo' operare.</b></para>
/// <list type="bullet">
/// <item><description>Opera solo fra <b>03:00 e 19:00</b>, ora della ricerca (CET): la finestra sta dentro la giornata</description></item>
...
/// <list type="bullet">
/// <item><description>Stop loss: <b>$750</b> per contratto = <b>0,01 pt</b></description></item>
/// <item><description>Take profit: <b>$2.500</b> = <b>0,02 pt</b></description></item>
/// <item><description>Nessun trailing stop</description></item>
/// <item><description>Nessun breakeven</description></item>
/// <item><description>Uscita a tempo dopo <b>460 barre</b> (9,6 giorni di calendario)</description></item>
/// </list>
///
...
/// <item><term>Atteso per trade</term><description>$253</description></item>
/// <item><term>Fuori campione</term><description>$40.309 su 107 trade</description></item>
/// <item><term>Drawdown</term><description>$5.283</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>JY_30m/consegna/trades/fam03_TF_U.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
public sealed class PTS_JY_TFU_005_30 : TfUnmirroredEngine
{
    public override string Name => "PTS_JY_TFU_005_30";
    public override string Description =>
        "TF_U JY 30m: S49 del dossier, run JY_30m, finestra 03:00-19:00 CET, multiday";
    public override string Symbol => "@JY";
    public override int TimeframeMinutes => 30;

    public PTS_JY_TFU_005_30()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(3, 19);   // start_hour 3, end_hour 19

        FastYesLong = 139;     // ptn_fast_yes_long
        FastNoLong = 30;       // ptn_fast_no_long
        FastYesShort = 6;      // ptn_fast_yes_short
        FastNoShort = 111;     // ptn_fast_no_short
        SkipDay = -1;         // skip_day (convenzione pandas, 0 = lunedi')

        IntradayOnly = false;    // intraday_only = 0

        StopMoney = 750;         // stop_loss, $ per contratto = 0,01 pt
        ProfitMoney = 2500;      // take_profit, $ per contratto = 0,02 pt
        TrailingStopMoney = 0;     // nessun trailing
        BreakEvenMoney = 0;        // nessun breakeven
        MaxBars = 460;          // max_bars: 460 barre da 30 minuti, 9,6 giorni di calendario
    }
