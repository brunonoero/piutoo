...
/// <summary>
/// PTS_GC_PCH_005_240 - PC su GC a 4 ore, <b>S62</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S62.</b> E' l'identificativo con cui questa strategia compare
/// nel dossier: e' da li' che si risale a condizioni, filtri e parametri per un controllo,
/// senza riaprire i CSV a tentativi. La riga di ricerca e' <c>run_20260824_1935</c>, famiglia
...
/// <list type="bullet">
/// <item><description>LONG: stop buy sul <b>massimo delle ultime 1 barre</b> + 2 tick</description></item>
/// <item><description>SHORT: stop sell sul <b>minimo delle ultime 1 barre</b> - 2 tick</description></item>
...
/// <item><description>deve essere FALSO - neutrale <c>12</c></description></item>
/// <item><description>deve essere VERO - direzionale <c>9</c></description></item>
/// <item><description>deve essere FALSO - direzionale <c>28</c></description></item>
/// </list>
///
/// <para><b>Quando puo' operare.</b></para>
/// <list type="bullet">
/// <item><description>Opera solo fra <b>00:00 e 09:00</b>, ora della ricerca (CET)</description></item>
...
/// <list type="bullet">
/// <item><description>Stop loss: <b>$2.500</b> per contratto = <b>25.00 pt</b></description></item>
/// <item><description>Take profit: <b>$10.000</b> = <b>100.00 pt</b></description></item>
...
/// </list>
///
/// <para><b>Contratto di riferimento:</b> GC, $100 per punto, tick 0,1.</para>
///
/// <para><b>Metriche di validazione storica - non sono garanzie di rendimento.</b></para>
/// <list type="table">
/// <listheader><term>Metrica</term><description>Valore</description></listheader>
/// <item><term>Atteso per trade</term><description>$102</description></item>
/// <item><term>Fuori campione</term><description>$53.332 su 333 trade</description></item>
/// <item><term>Drawdown</term><description>$16.988</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260824_1935/consegna/trades/fam03_PC.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
///
/// <para>ATTENZIONE: <b>non mettere su conti diversi</b> insieme a <c>4h fam03-2, 4h fam03-3</c> del
/// dossier: emettono gli stessi ordini di entrata, e due sistemi che mandano gli stessi
/// ordini sono copy trading.</para>
/// </summary>
public sealed class PTS_GC_PCH_005_240 : PriceChannelEngine
{
    public override string Name => "PTS_GC_PCH_005_240";
    public override string Description =>
        "PC GC 4 ore: S62 del dossier, run run_20260824_1935, finestra 00:00-09:00 CET, intraday";
    public override string Symbol => "@GC";
    public override int TimeframeMinutes => 240;

    public PTS_GC_PCH_005_240()
    {
        ...
        StopMoney = 2500;        // stop_loss, $ per contratto = 25.00 pt
        ProfitMoney = 10000;      // take_profit, $ per contratto = 100.00 pt
