...
/// <summary>
/// PTS_HO_BIA_002_240 - BIAS su HO a 4 ore, <b>S38</b> del dossier
/// <c>run-engine/run-08-settembre/DOSSIER_PANIERE (1).md</c>.
///
/// <para><b>Codice sorgente: S38.</b> E' l'identificativo con cui questa strategia compare
...
/// <c>fam02</c>, motore <c>BIAS</c>.</para>
///
...
/// <list type="bullet">
/// <item><description>LONG: stop buy sul <b>massimo della barra precedente</b></description></item>
/// <item><description>SHORT: stop sell sul <b>minimo della barra precedente</b></description></item>
/// <item><description>La finestra LONG e' <b>[1, 6)</b> barre di sessione, la SHORT <b>[1, 6)</b>: si arma alla barra di partenza e solo se i pattern sono veri in quel momento, poi resta attiva fino alla fine della finestra</description></item>
...
/// <list type="bullet">
/// <item><description>LONG deve essere VERO - fast <c>105</c>: <c>L_d0 &gt; L_d1 * (1 + 0.025)</c></description></item>
/// <item><description>LONG deve essere FALSO - fast <c>33</c>: <c>H_d0 - O_d0 &gt; (H_d1 - O_d1) * 0.75</c></description></item>
/// <item><description>SHORT deve essere VERO - fast <c>125</c>: <c>O_d0 &gt; C_d1 * (1 + 0.0075)</c></description></item>
/// <item><description>SHORT deve essere FALSO - fast <c>109</c>: <c>(H_d1 &lt; H_d2) E (H_d1 &lt; H_d3) E (H_d1 &lt; H_d4)</c></description></item>
/// </list>
///
/// <para><b>Quando puo' operare.</b></para>
/// <list type="bullet">
/// <item><description>Nessun filtro orario: opera su tutte le 24 ore</description></item>
/// <item><description><b>Non apre</b> posizioni LONG di lunedi' (<c>not_entry_day_long = 0</c>, convenzione pandas 0 = lunedi')</description></item>
/// <item><description>Nessun giorno escluso per lo SHORT (<c>not_entry_day_short = -1</c>)</description></item>
...
/// per il LONG e alla barra <b>5</b> per lo SHORT, market all'apertura di quella barra; stop e
...
/// <item><term>Atteso per trade</term><description>$312</description></item>
/// <item><term>Fuori campione</term><description>$159.774 su 391 trade</description></item>
/// <item><term>Drawdown</term><description>$9.149</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>HO_4h/consegna/trades/fam02_BIAS.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_HO_BIA_002_240 : BiasBarCountEngine
{
    public override string Name => "PTS_HO_BIA_002_240";
    public override string Description =>
        "BIAS HO 4 ore: S38 del dossier, run HO_4h, finestra 24h, uscita a indice di barra";
    ...
    public PTS_HO_BIA_002_240()
    {
        ...
        EndLong = 6;                   // fine finestra LONG (esclusa)
        ArmBarShort = 1;               // inizio finestra SHORT (inclusa)
        EndShort = 6;                  // fine finestra SHORT (esclusa)
        BreakoutBarsHigh = 1;          // massimo della barra precedente
        BreakoutBarsLow = 1;           // minimo della barra precedente
        ExitBarLong = 6;               // barra di uscita LONG
        ExitBarShort = 5;              // barra di uscita SHORT

        PatternLongYes = 105;          // gate fast del long
        PatternLongNo = 33;            // gate fast che impedisce il long
        PatternShortYes = 125;         // gate fast dello short
        PatternShortNo = 109;          // gate fast che impedisce lo short
        NotEntryDayLong = 0;           // niente LONG di lunedi' (0 = lunedi')
        NotEntryDayShort = -1;         // nessun giorno escluso per lo short
