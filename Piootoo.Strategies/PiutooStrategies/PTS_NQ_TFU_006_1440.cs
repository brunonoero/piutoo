...
/// <summary>
/// PTS_NQ_TFU_006_1440 - TF_U su NQ a giornaliero, <b>S05</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S05.</b> E' l'identificativo con cui questa strategia compare
...
/// <list type="bullet">
/// <item><description>LONG deve essere VERO - fast <c>39</c></description></item>
/// <item><description>LONG deve essere FALSO - fast <c>85</c></description></item>
/// <item><description>SHORT deve essere VERO - fast <c>2</c></description></item>
/// <item><description>SHORT deve essere FALSO - fast <c>150</c></description></item>
/// </list>
///
...
/// <item><description>Take profit: <b>$15.000</b> = <b>750.00 pt</b></description></item>
/// <item><description>Nessun trailing stop</description></item>
/// <item><description>Nessun breakeven</description></item>
/// <item><description>Uscita a tempo dopo <b>20 barre</b></description></item>
/// </list>
///
...
/// <item><term>Atteso per trade</term><description>$1.477</description></item>
/// <item><term>Fuori campione</term><description>$223.041 su 151 trade</description></item>
/// <item><term>Drawdown</term><description>$23.721</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260822_0736/consegna/trades/fam04_TF_U.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
///
/// <para>ATTENZIONE: <b>non mettere su conti diversi</b> insieme a <c>day fam04-2</c> del
/// dossier: emettono gli stessi ordini di entrata, e due sistemi che mandano gli stessi
/// ordini sono copy trading.</para>
/// </summary>
public sealed class PTS_NQ_TFU_006_1440 : TfUnmirroredEngine
{
    public override string Name => "PTS_NQ_TFU_006_1440";
    public override string Description =>
        "TF_U NQ giornaliero: S05 del dossier, run run_20260822_0736, finestra 24h, multiday";
    public override string Symbol => "@NQ";
    public override int TimeframeMinutes => 1440;

    public PTS_NQ_TFU_006_1440()
    {
        ...
        FastNoShort = 150;     // ptn_fast_no_short
        ...
        ProfitMoney = 15000;      // take_profit, $ per contratto = 750.00 pt
