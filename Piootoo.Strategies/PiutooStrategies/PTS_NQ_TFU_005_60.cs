...
/// <list type="bullet">
/// <item><description>deve essere VERO — fast 107: <c>L_d1 &gt; L_d5</c></description></item>
/// <item><description>deve essere FALSO — fast 83: <c>H_d0 &gt; H_d1 * (1 + 0.005)</c></description></item>
/// </list>
/// <para><b>Solo SHORT</b></para>
/// <list type="bullet">
/// <item><description>deve essere VERO — fast 21: <c>|O_d5-C_d1| &gt; 2.0 * (H_d5-L_d1)</c></description></item>
/// <item><description>deve essere FALSO — fast 39: <c>H_d0 - O_d0 &lt; H_d1 - O_d1</c></description></item>
/// </list>
///
/// <para><b>Quando può operare.</b></para>
/// <list type="bullet">
/// <item><description>Opera solo fra 16:00 e 04:00 (a cavallo della mezzanotte), ora dei dati (CET)</description></item>
...
/// <item><description>Uscita a tempo dopo 46 barre (1.9 giorni di calendario)</description></item>
/// </list>
///
...
/// <item><term>Atteso per trade</term><description>$90.8</description></item>
/// <item><term>Out-of-sample</term><description>$68,525 su 215 trade &#183; drawdown $24,928 &#183; profit factor 1.21 &#183; $319 per trade.</description></item>
...
/// <item><term>Monte Carlo drawdown p95</term><description>$58,409</description></item>
/// </list>
///
/// <para><b>Verifica del porting:</b> lista trade di riferimento
/// <c>run-engine/run-06-gosto/consegna/trades/fam06_TF_U.csv</c> (762 trade totali, 215 OOS,
/// 2012-01-10 → 2025-05-29).</para>
/// </summary>
public sealed class PTS_NQ_TFU_005_60 : TfUnmirroredEngine
{
    public override string Name => "PTS_NQ_TFU_005_60";
    public override string Description =>
        "TF_U NQ 60m: famiglia 06 run 20260820, finestra 16:00–04:00 CET, multiday";
    public override string Symbol => "@NQ";
    public override int TimeframeMinutes => 60;

    public PTS_NQ_TFU_005_60()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(16, 4);
        SkipDay = -1;   // skip_day (0 = lunedì, -1 = nessuno)

        FastYesLong = 107; // ptn_ly_yes
        FastNoLong = 83;   // ptn_ly_no
        FastYesShort = 21; // ptn_sy_yes
