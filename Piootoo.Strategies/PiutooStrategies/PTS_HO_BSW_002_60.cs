...
/// <summary>
/// PTS_HO_BSW_002_60 - BIASW su HO a 60 minuti, <b>S67</b> del dossier
/// <c>run-engine/run-08-settembre/DOSSIER_PANIERE (1).md</c>.
///
/// <para><b>Codice sorgente: S67.</b> E' l'identificativo con cui questa strategia compare
...
/// <list type="bullet">
/// <item><description>LONG: MARKET all'apertura della barra delle <b>23:00 di martedi'</b> (ora della ricerca, CET)</description></item>
/// <item><description>SHORT: MARKET all'apertura della barra delle <b>04:00 di lunedi'</b></description></item>
...
/// <list type="bullet">
/// <item><description>LONG deve essere VERO - fast <c>123</c>: <c>O_d0 &gt; C_d1 * (1 + 0.0025)</c></description></item>
/// <item><description>LONG deve essere FALSO - fast <c>84</c>: <c>H_d0 &gt; H_d1 * (1 + 0.0075)</c></description></item>
/// <item><description>SHORT deve essere VERO - fast <c>142</c>: <c>close &gt; O_d0 * 0.99</c></description></item>
/// <item><description>SHORT deve essere FALSO - fast <c>115</c>: <c>C_d1 - L_d1 &lt; 0.2 * (H_d1-L_d1)</c></description></item>
/// </list>
///
/// <para><b>Uscite.</b> Sono autocontenute nel segnale di ingresso e vengono applicate
/// dall'engine o dal broker: la strategia non emette mai segnali di chiusura.</para>
/// <list type="bullet">
/// <item><description>Uscita LONG programmata: <b>venerdi' alle 06:00</b>, market all'apertura di quella barra. E' l'uscita principale: stop e target agiscono solo se scattano prima.</description></item>
/// <item><description>Uscita SHORT programmata: <b>martedi' alle 23:00</b>, market all'apertura di quella barra.</description></item>
...
/// <item><description>Stop loss: <b>$1.250</b> per contratto = <b>0,03 pt</b></description></item>
/// <item><description>Take profit: <b>$3.000</b> = <b>0,07 pt</b></description></item>
...
/// <item><term>Atteso per trade</term><description>$171</description></item>
/// <item><term>Fuori campione</term><description>$63.458 su 151 trade</description></item>
/// <item><term>Drawdown</term><description>$11.435</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>HO_1h/consegna/trades/fam03_BIASW.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_HO_BSW_002_60 : BiasWeeklyEngine
{
    public override string Name => "PTS_HO_BSW_002_60";
    public override string Description =>
        "BIASW HO 60m: S67 del dossier, run HO_1h, long martedi' 23:00 -> venerdi' 06:00 CET, multiday";
    public override string Symbol => "@HO";
    public override int TimeframeMinutes => 60;

    public PTS_HO_BSW_002_60()
    {
        ...
        EntryDayLong = 1;      // le_day: martedi' (convenzione pandas, 0 = lunedi')
        EntryTimeLong = 2300;  // le_time: 23:00 ora della ricerca (CET)
        ExitDayLong = 4;       // lx_day: venerdi'
        ExitTimeLong = 600;    // lx_time: 06:00

        EntryDayShort = 0;     // se_day: lunedi'
        EntryTimeShort = 400;  // se_time: 04:00
        ExitDayShort = 1;      // sx_day: martedi'
        ExitTimeShort = 2300;  // sx_time: 23:00

        FastYesLong = 123;    // ptn_ly_yes: O_d0 > C_d1 * (1 + 0.0025)
        FastNoLong = 84;      // ptn_ly_no:  H_d0 > H_d1 * (1 + 0.0075)
        FastYesShort = 142;   // ptn_sy_yes: close > O_d0 * 0.99
        FastNoShort = 115;    // ptn_sy_no:  C_d1 - L_d1 < 0.2 * (H_d1-L_d1)

        StopMoneyLong = 1250m;    // stop_loss, $ per contratto = 0,03 pt
        ProfitMoneyLong = 3000m;  // take_profit, $ per contratto = 0,07 pt
        StopMoneyShort = 1250m;
        ProfitMoneyShort = 3000m;
