...
/// <summary>
/// PTS_NG_TFM_002_240 - TF_M su NG a 4 ore, <b>S68</b> del dossier
...
/// <list type="bullet">
/// <item><description>deve essere VERO - neutrale <c>53</c></description></item>
...
/// <list type="bullet">
/// <item><description>Stop loss: <b>$250</b> per contratto = <b>0.03 pt</b></description></item>
/// <item><description>Take profit: <b>$5.000</b> = <b>0.50 pt</b></description></item>
...
/// <item><term>Fuori campione</term><description>$94.460 su 345 trade</description></item>
/// <item><term>Drawdown</term><description>$7.560</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260824_1908/consegna/trades/fam03_TF_M.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_NG_TFM_002_240 : TfMirroredEngine
{
    public override string Name => "PTS_NG_TFM_002_240";
    public override string Description =>
        "TF_M NG 4 ore: S68 del dossier, run run_20260824_1908, finestra 00:00-17:00 CET, multiday";
    public override string Symbol => "@NG";
    public override int TimeframeMinutes => 240;

    public PTS_NG_TFM_002_240()
    {
        ...
        StopMoney = 250;        // stop_loss, $ per contratto = 0.03 pt
        ProfitMoney = 5000;      // take_profit, $ per contratto = 0.50 pt
