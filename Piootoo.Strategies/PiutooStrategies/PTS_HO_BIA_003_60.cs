...
/// <summary>
/// PTS_HO_BIA_003_60 - BIAS su HO a 60 minuti, <b>S116</b> del dossier
/// <c>run-engine/run-08-settembre/DOSSIER_PANIERE (1).md</c>.
///
/// <para><b>Codice sorgente: S116.</b> E' l'identificativo con cui questa strategia compare
...
/// <c>fam05</c>, motore <c>BIAS</c>.</para>
///
...
/// <item><description>La finestra LONG e' <b>[17, 21)</b> barre di sessione, la SHORT <b>[2, 7)</b>: si arma alla barra di partenza e solo se i pattern sono veri in quel momento, poi resta attiva fino alla fine della finestra</description></item>
...
/// <list type="bullet">
/// <item><description>LONG deve essere VERO - fast <c>142</c>: <c>close &gt; O_d0 * 0.99</c></description></item>
/// <item><description>LONG deve essere FALSO - fast <c>122</c>: <c>O_d0 &lt; C_d1 * (1 - 0.01)</c></description></item>
/// <item><description>SHORT deve essere VERO - fast <c>94</c>: <c>H_d1 &lt; H_d5</c></description></item>
/// <item><description>SHORT deve essere FALSO - fast <c>138</c>: <c>(C_d1 &gt; O_d1) E (C_d2 &lt; O_d2)</c></description></item>
/// </list>
///
/// <para><b>Quando puo' operare.</b></para>
/// <list type="bullet">
/// <item><description>Nessun filtro orario: opera su tutte le 24 ore</description></item>
/// <item><description><b>Non apre</b> posizioni LONG di mercoledi' (<c>not_entry_day_long = 2</c>, convenzione pandas 0 = lunedi')</description></item>
/// <item><description><b>Non apre</b> posizioni SHORT di mercoledi' (<c>not_entry_day_short = 2</c>)</description></item>
...
/// </list>
///
/// <para><b>Uscite.</b> L'uscita principale e' <b>obbligatoria alla barra 22</b> della sessione
/// per il LONG e alla barra <b>17</b> per lo SHORT, market all'apertura di quella barra; stop e
...
/// <item><term>Atteso per trade</term><description>$29</description></item>
/// <item><term>Fuori campione</term><description>$44.076 su 497 trade</description></item>
/// <item><term>Drawdown</term><description>$21.339</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>HO_1h/consegna/trades/fam05_BIAS.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
public sealed class PTS_HO_BIA_003_60 : BiasBarCountEngine
{
    ...
    public override string Description =>
        "BIAS HO 60m: S116 del dossier, run HO_1h, finestra 24h, uscita a indice di barra";
    public override string Symbol => "@HO";
    public override int TimeframeMinutes => 60;

    public PTS_HO_BIA_003_60()
    {
        ...
        ArmBarLong = 17;               // inizio finestra LONG (inclusa)
        EndLong = 21;                  // fine finestra LONG (esclusa)
        ArmBarShort = 2;               // inizio finestra SHORT (inclusa)
        EndShort = 7;                  // fine finestra SHORT (esclusa)
        BreakoutBarsHigh = 5;          // massimo delle 5 barre precedenti
        BreakoutBarsLow = 1;           // minimo della barra precedente
        ExitBarLong = 22;              // barra di uscita LONG
        ExitBarShort = 17;             // barra di uscita SHORT

        PatternLongYes = 142;          // gate fast del long
        PatternLongNo = 122;           // gate fast che impedisce il long
        PatternShortYes = 94;          // gate fast dello short
        PatternShortNo = 138;          // gate fast che impedisce lo short
        NotEntryDayLong = 2;           // niente LONG di mercoledi' (0 = lunedi')
        NotEntryDayShort = 2;          // niente SHORT di mercoledi'
