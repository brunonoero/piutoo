...
/// <summary>
/// PTS_BP_TFM_002_15 - TF_M su BP a 15 minuti, <b>S61</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S61.</b> E' l'identificativo con cui questa strategia compare
/// nel dossier: e' da li' che si risale a condizioni, filtri e parametri per un controllo,
/// senza riaprire i CSV a tentativi. La riga di ricerca e' <c>run_20260823_0343</c>, famiglia
...
/// <list type="bullet">
/// <item><description>deve essere VERO - neutrale <c>2</c></description></item>
/// <item><description>deve essere FALSO - neutrale <c>20</c></description></item>
/// <item><description>deve essere VERO - direzionale <c>45</c></description></item>
/// <item><description>deve essere FALSO - direzionale <c>-3</c></description></item>
/// </list>
///
/// <para><b>Quando puo' operare.</b></para>
/// <list type="bullet">
/// <item><description>Opera solo fra <b>23:00 e 22:00</b> (a cavallo della mezzanotte), ora della ricerca (CET)</description></item>
...
/// <list type="bullet">
/// <item><description>Stop loss: <b>$1.000</b> per contratto = <b>0.02 pt</b></description></item>
/// <item><description>Take profit: <b>$500</b> = <b>0.01 pt</b></description></item>
...
/// </list>
///
/// <para><b>Contratto di riferimento:</b> BP, $62.500 per punto, tick 0,0001.</para>
///
/// <para><b>Metriche di validazione storica - non sono garanzie di rendimento.</b></para>
/// <list type="table">
/// <listheader><term>Metrica</term><description>Valore</description></listheader>
/// <item><term>Atteso per trade</term><description>$104</description></item>
/// <item><term>Fuori campione</term><description>$5.629 su 33 trade</description></item>
/// <item><term>Drawdown</term><description>$2.341</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260823_0343/consegna/trades/fam01_TF_M.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_BP_TFM_002_15 : TfMirroredEngine
{
    public override string Name => "PTS_BP_TFM_002_15";
    public override string Description =>
        "TF_M BP 15 minuti: S61 del dossier, run run_20260823_0343, finestra 23:00-22:00 CET, multiday";
    public override string Symbol => "@BP";
    public override int TimeframeMinutes => 15;

    public PTS_BP_TFM_002_15()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(23, 22);   // start_hour 23, end_hour 22

        NeutralYes = 2;      // ptn_neut_yes
        NeutralNo = 20;       // ptn_neut_no
        DirectionalYes = 45;  // ptn_dir_yes (il segno lo applica il motore per verso)
        DirectionalNo = -3;   // ptn_dir_no
        SkipDay = -1;         // skip_day (convenzione pandas, 0 = lunedi')

        IntradayOnly = false;    // intraday_only = 0

        StopMoney = 1000;        // stop_loss, $ per contratto = 0.02 pt
        ProfitMoney = 500;      // take_profit, $ per contratto = 0.01 pt
