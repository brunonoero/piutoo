...
/// <summary>
/// PTS_ES_TFU_001_1440 - TF_U su ES a giornaliero, <b>S45</b> del dossier
...
/// <list type="bullet">
/// <item><description>LONG deve essere VERO - fast <c>4</c></description></item>
/// <item><description>LONG deve essere FALSO - fast <c>139</c></description></item>
/// <item><description>SHORT deve essere VERO - fast <c>62</c></description></item>
/// <item><description>SHORT deve essere FALSO - fast <c>67</c></description></item>
/// </list>
///
...
/// <list type="bullet">
/// <item><description>Stop loss: <b>$2.000</b> per contratto = <b>40.00 pt</b></description></item>
...
/// <item><term>Atteso per trade</term><description>$176</description></item>
/// <item><term>Fuori campione</term><description>$122.200 su 153 trade</description></item>
/// <item><term>Drawdown</term><description>$23.176</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260822_1249/consegna/trades/fam03_TF_U.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_ES_TFU_001_1440 : TfUnmirroredEngine
{
    public override string Name => "PTS_ES_TFU_001_1440";
    public override string Description =>
        "TF_U ES giornaliero: S45 del dossier, run run_20260822_1249, finestra 24h, multiday";
    public override string Symbol => "@ES";
    public override int TimeframeMinutes => 1440;

    public PTS_ES_TFU_001_1440()
    {
        ...
        FastNoLong = 139;      // ptn_fast_no_long
        FastYesShort = 62;    // ptn_fast_yes_short
        FastNoShort = 67;     // ptn_fast_no_short
        SkipDay = -1;         // skip_day (convenzione pandas, 0 = lunedi')

        IntradayOnly = false;    // intraday_only = 0

        StopMoney = 2000;        // stop_loss, $ per contratto = 40.00 pt
