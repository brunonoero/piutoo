...
/// <summary>
/// PTS_YM_TFM_001_240 - TF_M su YM a 4 ore, <b>S36</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S36.</b> E' l'identificativo con cui questa strategia compare
...
/// <item><description>deve essere FALSO - direzionale <c>31</c></description></item>
/// </list>
///
/// <para><b>Quando puo' operare.</b></para>
/// <list type="bullet">
/// <item><description>Opera solo fra <b>06:00 e 09:00</b>, ora della ricerca (CET)</description></item>
...
/// <item><term>Atteso per trade</term><description>$239</description></item>
/// <item><term>Fuori campione</term><description>$44.870 su 55 trade</description></item>
/// <item><term>Drawdown</term><description>$9.579</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260824_1550/consegna/trades/fam01_TF_M.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_YM_TFM_001_240 : TfMirroredEngine
{
    public override string Name => "PTS_YM_TFM_001_240";
    public override string Description =>
        "TF_M YM 4 ore: S36 del dossier, run run_20260824_1550, finestra 06:00-09:00 CET, multiday";
    public override string Symbol => "@YM";
    public override int TimeframeMinutes => 240;

    public PTS_YM_TFM_001_240()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(6, 9);   // start_hour 6, end_hour 9
