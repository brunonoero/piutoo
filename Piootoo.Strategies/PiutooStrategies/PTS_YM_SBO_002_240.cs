...
/// <summary>
/// PTS_YM_SBO_002_240 - BO su YM a 4 ore, <b>S73</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S73.</b> E' l'identificativo con cui questa strategia compare
...
/// <list type="bullet">
/// <item><description>LONG: stop buy sul <b>massimo in costruzione della sessione corrente</b> + 2 tick</description></item>
/// <item><description>SHORT: stop sell sul <b>minimo in costruzione della sessione corrente</b> - 2 tick</description></item>
/// <item><description><c>n_sess = 1</c>, <c>lev_include_sess0 = 1</c>, <c>breakout_offset_ticks = 2</c>: l'offset e' esattamente <c>2 x tick</c>, senza tick impliciti</description></item>
/// <item><description>Il massimo/minimo corrente INCLUDE la barra in corso: l'ordine emesso alla barra i vive solo alla barra i+1, quindi non c'e' look-ahead</description></item>
/// </list>
///
...
/// <list type="bullet">
/// <item><description>deve essere VERO - neutrale <c>25</c></description></item>
/// <item><description>deve essere FALSO - neutrale <c>46</c></description></item>
/// <item><description>deve essere VERO - direzionale <c>-33</c></description></item>
/// <item><description>deve essere FALSO - direzionale <c>7</c></description></item>
/// </list>
///
/// <para><b>Quando puo' operare.</b></para>
/// <list type="bullet">
/// <item><description>Opera solo fra <b>14:00 e 05:00</b> (a cavallo della mezzanotte), ora della ricerca (CET)</description></item>
...
/// <item><description>Take profit: <b>$3.000</b> = <b>600.00 pt</b></description></item>
/// <item><description>Nessun trailing stop</description></item>
/// <item><description>Nessun breakeven</description></item>
/// <item><description>Uscita a tempo dopo <b>12 barre</b></description></item>
/// </list>
///
...
/// <item><term>Atteso per trade</term><description>$63</description></item>
/// <item><term>Fuori campione</term><description>$57.433 su 173 trade</description></item>
/// <item><term>Drawdown</term><description>$6.102</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260824_1550/consegna/trades/fam06_BO.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_YM_SBO_002_240 : SessionBreakoutEngine
{
    public override string Name => "PTS_YM_SBO_002_240";
    public override string Description =>
        "BO YM 4 ore: S73 del dossier, run run_20260824_1550, finestra 14:00-05:00 CET, multiday";
    public override string Symbol => "@YM";
    public override int TimeframeMinutes => 240;

    public PTS_YM_SBO_002_240()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(14, 5);   // start_hour 14, end_hour 5
        ...
        DirectionalYes = -33;  // ptn_dir_yes (il segno lo applica il motore per verso)
        DirectionalNo = 7;   // ptn_dir_no

        IntradayOnly = false;    // intraday_only = 0

        StopMoney = 250;        // stop_loss, $ per contratto = 50.00 pt
        ProfitMoney = 3000;      // take_profit, $ per contratto = 600.00 pt
