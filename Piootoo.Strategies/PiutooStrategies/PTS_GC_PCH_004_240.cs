...
/// <summary>
/// PTS_GC_PCH_004_240 - PC su GC a 4 ore, <b>S51</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S51.</b> E' l'identificativo con cui questa strategia compare
...
/// <list type="bullet">
/// <item><description>deve essere VERO - neutrale <c>31</c></description></item>
...
/// <list type="bullet">
/// <item><description>Opera solo fra <b>00:00 e 12:00</b>, ora della ricerca (CET)</description></item>
...
/// <list type="bullet">
/// <item><description>Stop loss: <b>$500</b> per contratto = <b>5.00 pt</b></description></item>
...
/// <item><term>Atteso per trade</term><description>$145</description></item>
/// <item><term>Fuori campione</term><description>$93.240 su 410 trade</description></item>
/// <item><term>Drawdown</term><description>$10.886</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260824_1935/consegna/trades/fam02_PC.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_GC_PCH_004_240 : PriceChannelEngine
{
    public override string Name => "PTS_GC_PCH_004_240";
    public override string Description =>
        "PC GC 4 ore: S51 del dossier, run run_20260824_1935, finestra 00:00-12:00 CET, intraday";
    public override string Symbol => "@GC";
    public override int TimeframeMinutes => 240;

    public PTS_GC_PCH_004_240()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(0, 12);   // start_hour 0, end_hour 12
        ...
        StopMoney = 500;        // stop_loss, $ per contratto = 5.00 pt
