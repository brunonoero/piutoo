...
/// <summary>
/// PTS_NG_TFU_003_60 - TF_U su NG a 60 minuti, <b>S45</b> del dossier
/// <c>run-engine/run-08-settembre/DOSSIER_PANIERE (1).md</c>.
///
/// <para><b>Codice sorgente: S45.</b> E' l'identificativo con cui questa strategia compare
...
/// essere FALSO".</para>
/// <list type="bullet">
/// <item><description>LONG deve essere VERO - fast <c>145</c>: <c>close &gt; O_d0 * 1.005</c></description></item>
/// <item><description>LONG deve essere FALSO - fast <c>129</c>: <c>((H_d1-L_d1) &lt; H_d2 - L_d2) E (H_d2 - L_d2 &lt; H_d3 - L_d3)</c></description></item>
/// <item><description>SHORT deve essere VERO - fast <c>64</c>: <c>H_d0 &lt; L_d0 * (1 + 0.02)</c></description></item>
/// <item><description>SHORT deve essere FALSO - fast <c>73</c>: <c>C_d1 &lt; C_d2 * (1 - 0.015)</c></description></item>
/// </list>
///
/// <para><b>Quando puo' operare.</b></para>
/// <list type="bullet">
/// <item><description>Opera solo fra <b>08:00 e 23:00</b>, ora della ricerca (CET): la finestra sta dentro la giornata</description></item>
...
/// <item><description>Take profit: <b>$2.500</b> = <b>0,25 pt</b></description></item>
...
/// <item><term>Atteso per trade</term><description>$278</description></item>
/// <item><term>Fuori campione</term><description>$83.108 su 282 trade</description></item>
/// <item><term>Drawdown</term><description>$20.122</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>NG_1h/consegna/trades/fam01_TF_U.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_NG_TFU_003_60 : TfUnmirroredEngine
{
    public override string Name => "PTS_NG_TFU_003_60";
    public override string Description =>
        "TF_U NG 60m: S45 del dossier, run NG_1h, finestra 08:00-23:00 CET, multiday";
    ...
    public PTS_NG_TFU_003_60()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(8, 23);   // start_hour 8, end_hour 23

        FastYesLong = 145;     // ptn_fast_yes_long
        FastNoLong = 129;      // ptn_fast_no_long
        FastYesShort = 64;     // ptn_fast_yes_short
        FastNoShort = 73;      // ptn_fast_no_short
        ...
        ProfitMoney = 2500;      // take_profit, $ per contratto = 0,25 pt
