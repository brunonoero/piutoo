...
/// <summary>
/// PTS_YM_SBO_001_240 - BO su YM a 4 ore, <b>S72</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S72.</b> E' l'identificativo con cui questa strategia compare
...
/// <list type="bullet">
/// <item><description>LONG: stop buy sul <b>massimo in costruzione della sessione corrente</b> + 5 tick</description></item>
/// <item><description>SHORT: stop sell sul <b>minimo in costruzione della sessione corrente</b> - 5 tick</description></item>
/// <item><description><c>n_sess = 2</c>, <c>lev_include_sess0 = 1</c>, <c>breakout_offset_ticks = 5</c>: l'offset e' esattamente <c>5 x tick</c>, senza tick impliciti</description></item>
...
/// <list type="bullet">
/// <item><description>deve essere VERO - neutrale <c>5</c></description></item>
...
/// <item><description>deve essere FALSO - direzionale <c>-10</c></description></item>
/// </list>
///
...
/// <item><description>Uscita a tempo dopo <b>35 barre</b></description></item>
/// </list>
///
...
/// <item><term>Fuori campione</term><description>$114.200 su 305 trade</description></item>
/// <item><term>Drawdown</term><description>$17.007</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260824_1550/consegna/trades/fam05_BO.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_YM_SBO_001_240 : SessionBreakoutEngine
{
    public override string Name => "PTS_YM_SBO_001_240";
    public override string Description =>
        "BO YM 4 ore: S72 del dossier, run run_20260824_1550, finestra 14:00-05:00 CET, multiday";
    public override string Symbol => "@YM";
    public override int TimeframeMinutes => 240;

    public PTS_YM_SBO_001_240()
    {
        ...
        BreakoutOffsetTicks = 5;       // breakout_offset_ticks
        TickSize = 1m;              // tick YM
