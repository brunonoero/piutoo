...
/// <summary>
/// PTS_NQ_TFM_002_15 — TF_M su NQ a 15 minuti, famiglia 01 della consegna
/// <c>run_20260814_1453</c>.
///
/// <para><b>Codice sorgente: S21.</b> E' l'identificativo con cui questa strategia
...
/// <c>run_20260814_1453/consegna/trades/fam01_TF_M.csv</c>.</para>
///
...
/// <list type="bullet">
/// <item><description>deve essere VERO — direzionale 12: <c>(H_d1 &gt; H_d2) E (L_d1 &gt; L_d2)</c></description></item>
/// <item><description>deve essere FALSO — direzionale 39: <c>O_d0 &gt; H_d1</c></description></item>
/// </list>
/// <para><b>Solo SHORT</b></para>
/// <list type="bullet">
/// <item><description>deve essere VERO — direzionale 12: <c>(H_d1 &lt; H_d2) E (L_d1 &lt; L_d2)</c></description></item>
/// <item><description>deve essere FALSO — direzionale 39: <c>O_d0 &lt; L_d1</c></description></item>
/// </list>
///
/// <para><b>Quando può operare.</b></para>
/// <list type="bullet">
/// <item><description>Opera solo fra 09:00 e 05:00 (a cavallo della mezzanotte), ora dei dati (CET)</description></item>
...
/// <list type="bullet">
/// <item><description>Stop loss: $3,000 per contratto = 150.00 pt</description></item>
/// <item><description>Take profit: $4,000 = 200.00 pt</description></item>
...
/// <item><term>Atteso per trade</term><description>$436.2</description></item>
/// <item><term>Out-of-sample</term><description>$136,408 su 153 trade &#183; drawdown $25,934 &#183; profit factor 1.70 &#183; $892 per trade.</description></item>
...
/// <item><term>Monte Carlo drawdown p95</term><description>$40,824</description></item>
/// </list>
/// </summary>
public sealed class PTS_NQ_TFM_002_15 : TfMirroredEngine
{
    public override string Name => "PTS_NQ_TFM_002_15";
    public override string Description =>
        "TF_M NQ 15m: famiglia 01 run 20260814, finestra 09:00–05:00 CET, multiday";
    public override string Symbol => "@NQ";
    public override int TimeframeMinutes => 15;

    public PTS_NQ_TFM_002_15()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(9, 5);
        SkipDay = 4;   // skip_day (0 = lunedì, -1 = nessuno)

        NeutralYes = 47;     // ptn_neut_yes
        NeutralNo = 7;       // ptn_neut_no
        DirectionalYes = 12; // ptn_dir_yes, specchiato dal motore
        DirectionalNo = 39;  // ptn_dir_no, specchiato dal motore

        IntradayOnly = false; // intraday_only

        StopMoney = 3000;   // stop_loss, $ per contratto = 150.00 pt
        ProfitMoney = 4000; // take_profit, $ per contratto
