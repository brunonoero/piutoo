...
/// <summary>
/// PTS_NQ_TFM_013_1440 - TF_M su NQ a giornaliero, <b>S03</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S03.</b> E' l'identificativo con cui questa strategia compare
...
/// <list type="bullet">
/// <item><description>deve essere VERO - neutrale <c>24</c></description></item>
/// <item><description>deve essere FALSO - neutrale <c>35</c></description></item>
/// <item><description>deve essere VERO - direzionale <c>44</c></description></item>
/// <item><description>deve essere FALSO - direzionale <c>29</c></description></item>
/// </list>
///
...
/// <item><term>Atteso per trade</term><description>$1.898</description></item>
/// <item><term>Fuori campione</term><description>$102.474 su 54 trade</description></item>
/// <item><term>Drawdown</term><description>$21.781</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260822_0736/consegna/trades/fam03_TF_M.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
///
/// <para>ATTENZIONE: <b>non mettere su conti diversi</b> insieme a <c>day fam02-2</c> del
/// dossier: emettono gli stessi ordini di entrata, e due sistemi che mandano gli stessi
/// ordini sono copy trading.</para>
/// </summary>
public sealed class PTS_NQ_TFM_013_1440 : TfMirroredEngine
{
    public override string Name => "PTS_NQ_TFM_013_1440";
    public override string Description =>
        "TF_M NQ giornaliero: S03 del dossier, run run_20260822_0736, finestra 24h, multiday";
    public override string Symbol => "@NQ";
    public override int TimeframeMinutes => 1440;

    public PTS_NQ_TFM_013_1440()
    {
        ...
        DirectionalYes = 44;  // ptn_dir_yes (il segno lo applica il motore per verso)
