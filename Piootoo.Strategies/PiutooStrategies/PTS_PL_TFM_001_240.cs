...
/// <summary>
/// PTS_PL_TFM_001_240 - TF_M su PL a 4 ore, <b>S74</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S74.</b> E' l'identificativo con cui questa strategia compare
/// nel dossier: e' da li' che si risale a condizioni, filtri e parametri per un controllo,
/// senza riaprire i CSV a tentativi. La riga di ricerca e' <c>run_20260824_2133</c>, famiglia
...
/// <list type="bullet">
/// <item><description>deve essere VERO - neutrale <c>6</c></description></item>
/// <item><description>deve essere FALSO - neutrale <c>19</c></description></item>
/// <item><description>deve essere VERO - direzionale <c>38</c></description></item>
/// <item><description>deve essere FALSO - direzionale <c>50</c></description></item>
/// </list>
///
/// <para><b>Quando puo' operare.</b></para>
/// <list type="bullet">
/// <item><description>Opera solo fra <b>00:00 e 08:00</b>, ora della ricerca (CET)</description></item>
...
/// <list type="bullet">
/// <item><description>Stop loss: <b>$250</b> per contratto = <b>5.00 pt</b></description></item>
/// <item><description>Take profit: <b>$2.500</b> = <b>50.00 pt</b></description></item>
...
/// </list>
///
/// <para><b>Contratto di riferimento:</b> PL, $50 per punto, tick 0,1.</para>
///
/// <para><b>Metriche di validazione storica - non sono garanzie di rendimento.</b></para>
/// <list type="table">
/// <listheader><term>Metrica</term><description>Valore</description></listheader>
/// <item><term>Atteso per trade</term><description>$52</description></item>
/// <item><term>Fuori campione</term><description>$15.985 su 115 trade</description></item>
/// <item><term>Drawdown</term><description>$2.613</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260824_2133/consegna/trades/fam01_TF_M.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_PL_TFM_001_240 : TfMirroredEngine
{
    public override string Name => "PTS_PL_TFM_001_240";
    public override string Description =>
        "TF_M PL 4 ore: S74 del dossier, run run_20260824_2133, finestra 00:00-08:00 CET, intraday";
    public override string Symbol => "@PL";
    public override int TimeframeMinutes => 240;

    public PTS_PL_TFM_001_240()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(0, 8);   // start_hour 0, end_hour 8

        NeutralYes = 6;      // ptn_neut_yes
        NeutralNo = 19;       // ptn_neut_no
        DirectionalYes = 38;  // ptn_dir_yes (il segno lo applica il motore per verso)
        DirectionalNo = 50;   // ptn_dir_no
        SkipDay = -1;         // skip_day (convenzione pandas, 0 = lunedi')

        IntradayOnly = true;    // intraday_only = 1

        StopMoney = 250;        // stop_loss, $ per contratto = 5.00 pt
        ProfitMoney = 2500;      // take_profit, $ per contratto = 50.00 pt
