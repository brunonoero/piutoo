...
/// <summary>
/// PTS_JY_TFU_007_60 - TF_U su JY a 60 minuti, <b>S74</b> del dossier
...
/// essere FALSO". Il dossier non dichiara nulla per il gate positivo dello short, che resta
/// quindi alla sentinella e <b>non filtra nulla</b>.</para>
/// <list type="bullet">
...
/// <list type="bullet">
/// <item><description>Stop loss: <b>$2.000</b> per contratto = <b>0,02 pt</b></description></item>
...
/// <item><term>Atteso per trade</term><description>$149</description></item>
/// <item><term>Fuori campione</term><description>$37.563 su 65 trade</description></item>
/// <item><term>Drawdown</term><description>$9.556</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>JY_1h/consegna/trades/fam02_TF_U.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
public sealed class PTS_JY_TFU_007_60 : TfUnmirroredEngine
{
    public override string Name => "PTS_JY_TFU_007_60";
    public override string Description =>
        "TF_U JY 60m: S74 del dossier, run JY_1h, finestra 07:00-01:00 CET, multiday";
    public override string Symbol => "@JY";
    public override int TimeframeMinutes => 60;

    public PTS_JY_TFU_007_60()
    {
        ...
        FastYesShort = 152;    // sentinella: il dossier non dichiara un gate positivo per lo short
        FastNoShort = 137;     // ptn_fast_no_short
        SkipDay = -1;         // skip_day (convenzione pandas, 0 = lunedi')

        IntradayOnly = false;    // intraday_only = 0

        StopMoney = 2000;        // stop_loss, $ per contratto = 0,02 pt
