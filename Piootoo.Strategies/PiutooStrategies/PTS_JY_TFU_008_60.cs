...
/// <summary>
/// PTS_JY_TFU_008_60 - TF_U su JY a 60 minuti, <b>S104</b> del dossier
/// <c>run-engine/run-08-settembre/DOSSIER_PANIERE (1).md</c>.
///
/// <para><b>Codice sorgente: S104.</b> E' l'identificativo con cui questa strategia compare
...
/// <item><description>LONG deve essere FALSO - fast <c>85</c>: <c>H_d0 &gt; H_d1 * (1 + 0.01)</c></description></item>
/// <item><description>SHORT deve essere VERO - fast <c>18</c>: <c>|O_d5-C_d1| &gt; 0.75 * (H_d5-L_d1)</c></description></item>
/// <item><description>SHORT deve essere FALSO - fast <c>95</c>: <c>L_d0 &lt; L_d1</c></description></item>
/// </list>
///
/// <para><b>Quando puo' operare.</b></para>
/// <list type="bullet">
/// <item><description>Opera solo fra <b>13:00 e 10:00</b>, ora della ricerca (CET): la finestra attraversa la mezzanotte</description></item>
...
/// <list type="bullet">
/// <item><description>Stop loss: <b>$5.000</b> per contratto = <b>0,04 pt</b></description></item>
...
/// <item><term>Fuori campione</term><description>$34.293 su 109 trade</description></item>
/// <item><term>Drawdown</term><description>$9.639</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>JY_1h/consegna/trades/fam03_TF_U.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
public sealed class PTS_JY_TFU_008_60 : TfUnmirroredEngine
{
    public override string Name => "PTS_JY_TFU_008_60";
    public override string Description =>
        "TF_U JY 60m: S104 del dossier, run JY_1h, finestra 13:00-10:00 CET, multiday";
    public override string Symbol => "@JY";
    public override int TimeframeMinutes => 60;

    public PTS_JY_TFU_008_60()
    {
