...
/// <summary>
/// PTS_NQ_TFM_011_60 — TF_M su NQ a 60 minuti, famiglia 05 della consegna
/// <c>run_20260820_0856</c> (S05 del <i>vecchio</i> dossier NQ 1h).
///
/// <para><b>Codice sorgente: S35.</b> E' l'identificativo con cui questa strategia
...
/// <c>run_20260820_0856/consegna/trades/fam05_TF_M.csv</c>.</para>
///
...
/// <list type="bullet">
/// <item><description>Opera solo fra 21:00 e 14:00 (a cavallo della mezzanotte), ora dei dati (CET)</description></item>
...
/// <item><term>Atteso per trade</term><description>$242.1</description></item>
/// <item><term>Out-of-sample</term><description>$45,941 su 181 trade &#183; drawdown $15,665 &#183; profit factor 1.28 &#183; $254 per trade.</description></item>
...
/// <item><term>Monte Carlo drawdown p95</term><description>$36,070</description></item>
/// </list>
///
/// <para><b>Verifica del porting:</b> lista trade di riferimento
/// <c>run-engine/run-06-gosto/consegna/trades/fam05_TF_M.csv</c> (451 trade totali, 181 OOS,
/// 2012-01-10 → 2025-05-29).</para>
/// </summary>
public sealed class PTS_NQ_TFM_011_60 : TfMirroredEngine
{
    public override string Name => "PTS_NQ_TFM_011_60";
    public override string Description =>
        "TF_M NQ 60m: famiglia 05 run 20260820, finestra 21:00–14:00 CET, multiday";
    public override string Symbol => "@NQ";
    public override int TimeframeMinutes => 60;

    public PTS_NQ_TFM_011_60()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(21, 14);
        ...
        ProfitMoney = 4000; // take_profit, $ per contratto = 200.00 pt
