...
/// <summary>
/// PTS_BTC_BIA_001_60 - BIAS su BTC a 60 minuti, <b>S19</b> del dossier
/// <c>run-engine/run-08-settembre/DOSSIER_PANIERE (1).md</c>.
///
/// <para><b>Codice sorgente: S19.</b> E' l'identificativo con cui questa strategia compare
...
/// (tabella §2.1 del dossier: BTC parte a 00:00 CET). Gli indici di barra si contano da quel
/// confine, non dall'ora di borsa.</para>
///
/// <para><b>Livelli di ingresso.</b></para>
/// <list type="bullet">
/// <item><description>LONG: stop buy sul <b>massimo delle 5 barre precedenti</b></description></item>
/// <item><description>SHORT: stop sell sul <b>minimo delle 3 barre precedenti</b></description></item>
/// <item><description>La finestra LONG e' <b>[1, 12)</b> barre di sessione, la SHORT <b>[10, 21)</b>: si arma alla barra di partenza e solo se i pattern sono veri in quel momento, poi resta attiva fino alla fine della finestra</description></item>
...
/// <list type="bullet">
/// <item><description>LONG deve essere VERO - fast <c>89</c>: <c>H_d0 &lt; H_d1 * (1 - 0.01)</c></description></item>
/// <item><description>LONG deve essere FALSO - fast <c>120</c>: <c>O_d0 &lt; C_d1 * (1 - 0.005)</c></description></item>
/// <item><description>SHORT deve essere VERO - fast <c>12</c>: <c>|O_d5-C_d1| &lt; 0.75 * (H_d5-L_d1)</c></description></item>
...
/// <item><description><b>Non apre</b> posizioni LONG di martedi' (<c>not_entry_day_long = 1</c>, convenzione pandas 0 = lunedi')</description></item>
/// <item><description><b>Non apre</b> posizioni SHORT di martedi' (<c>not_entry_day_short = 1</c>)</description></item>
...
/// </list>
///
/// <para><b>Uscite.</b> L'uscita principale e' <b>obbligatoria alla barra 14</b> della sessione
/// per il LONG e alla barra <b>7</b> per lo SHORT, market all'apertura di quella barra; stop e
...
/// <item><description>Take profit: <b>$10.000</b> = <b>2.000,00 pt</b></description></item>
...
/// <item><term>Atteso per trade</term><description>$741</description></item>
/// <item><term>Fuori campione</term><description>$207.095 su 242 trade</description></item>
/// <item><term>Drawdown</term><description>$16.350</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>BTC_1h/consegna/trades/fam03_BIAS.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
///
/// <para>ATTENZIONE: <b>non mettere su conti diversi</b> insieme a <c>1h fam03-2</c> del
/// dossier: emettono gli stessi ordini di entrata, e due sistemi che mandano gli stessi
/// ordini sono copy trading.</para>
/// </summary>
public sealed class PTS_BTC_BIA_001_60 : BiasBarCountEngine
{
    public override string Name => "PTS_BTC_BIA_001_60";
    public override string Description =>
        "BIAS BTC 60m: S19 del dossier, run BTC_1h, finestra 24h, uscita a indice di barra";
    public override string Symbol => "@BTC";
    public override int TimeframeMinutes => 60;

    public PTS_BTC_BIA_001_60()
    {
        ...
        EndLong = 12;                  // fine finestra LONG (esclusa)
        ArmBarShort = 10;              // inizio finestra SHORT (inclusa)
        EndShort = 21;                 // fine finestra SHORT (esclusa)
        BreakoutBarsHigh = 5;          // massimo delle 5 barre precedenti
        BreakoutBarsLow = 3;           // minimo delle 3 barre precedenti
        ExitBarLong = 14;              // barra di uscita LONG
        ExitBarShort = 7;              // barra di uscita SHORT

        PatternLongYes = 89;           // gate fast del long
        PatternLongNo = 120;           // gate fast che impedisce il long
        PatternShortYes = 12;          // gate fast dello short
        PatternShortNo = 11;           // gate fast che impedisce lo short
        NotEntryDayLong = 1;           // niente LONG di martedi' (0 = lunedi')
        NotEntryDayShort = 1;          // niente SHORT di martedi'

        StopMoney = 250;         // stop_loss, $ per contratto = 50.00 pt
        ProfitMoney = 10000;     // take_profit, $ per contratto = 2.000,00 pt
