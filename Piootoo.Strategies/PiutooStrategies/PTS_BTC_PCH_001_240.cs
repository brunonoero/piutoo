...
/// <summary>
/// PTS_BTC_PCH_001_240 - PC su BTC a 4 ore, <b>S16</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S16.</b> E' l'identificativo con cui questa strategia compare
/// nel dossier: e' da li' che si risale a condizioni, filtri e parametri per un controllo,
/// senza riaprire i CSV a tentativi. La riga di ricerca e' <c>run_20260824_2232</c>, famiglia
...
/// <item><description>deve essere FALSO - neutrale <c>45</c></description></item>
/// <item><description>deve essere VERO - direzionale <c>47</c></description></item>
/// <item><description>deve essere FALSO - direzionale <c>30</c></description></item>
/// </list>
///
...
/// <list type="bullet">
/// <item><description>Stop loss: <b>$1.750</b> per contratto = <b>350.00 pt</b></description></item>
...
/// <item><term>Atteso per trade</term><description>$588</description></item>
/// <item><term>Fuori campione</term><description>$272.875 su 305 trade</description></item>
/// <item><term>Drawdown</term><description>$25.340</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260824_2232/consegna/trades/fam01_PC.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_BTC_PCH_001_240 : PriceChannelEngine
{
    public override string Name => "PTS_BTC_PCH_001_240";
    public override string Description =>
        "PC BTC 4 ore: S16 del dossier, run run_20260824_2232, finestra 06:00-23:59 CET, multiday";
    public override string Symbol => "@BTC";
    public override int TimeframeMinutes => 240;

    public PTS_BTC_PCH_001_240()
    {
        ...
        StopMoney = 1750;        // stop_loss, $ per contratto = 350.00 pt
