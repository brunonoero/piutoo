...
/// <summary>
/// PTS_NG_TFM_005_30 - TF_M su NG a 30 minuti, <b>S70</b> del dossier
...
/// <list type="bullet">
/// <item><description>deve essere VERO - neutrale <c>26</c>: <c>|O_d5-C_d1| &lt; 0.75 * (HH5-LL5)</c></description></item>
/// <item><description>deve essere FALSO - neutrale <c>56</c> <i>(sentinella: nessun filtro)</i></description></item>
/// <item><description>deve essere VERO - direzionale <c>3</c>: long <c>H_d0 - O_d0 &gt; (H_d1 - O_d1) * 0.75</c>, short <c>O_d0 - L_d0 &gt; (O_d1 - L_d1) * 0.75</c></description></item>
/// <item><description>deve essere FALSO - direzionale <c>-37</c>: long <c>(C_d1 &lt; C_d2) E (C_d2 &lt; C_d3) E (O_d0 &lt; C_d1)</c>, short la stessa a specchio</description></item>
/// </list>
///
/// <para><b>Quando puo' operare.</b></para>
/// <list type="bullet">
/// <item><description>Opera solo fra <b>03:00 e 23:59</b>, ora della ricerca (CET). La fine e' <c>23:59</c> e non un'ora piena: e' scritta cosi' nella ricerca e va riportata verbatim, per questo la finestra usa <c>ZonedWindow.Research</c> invece di <c>ResearchHours</c></description></item>
...
/// <item><term>Atteso per trade</term><description>$162</description></item>
/// <item><term>Fuori campione</term><description>$63.274 su 341 trade</description></item>
/// <item><term>Drawdown</term><description>$17.454</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>NG_30m/consegna/trades/fam02_TF_M.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_NG_TFM_005_30 : TfMirroredEngine
{
    public override string Name => "PTS_NG_TFM_005_30";
    public override string Description =>
        "TF_M NG 30m: S70 del dossier, run NG_30m, finestra 03:00-23:59 CET, multiday";
    public override string Symbol => "@NG";
    public override int TimeframeMinutes => 30;

    public PTS_NG_TFM_005_30()
    {
        ...
        TradingWindow = ZonedWindow.Research(300, 2359);   // start_hour 3, fine a 23:59
