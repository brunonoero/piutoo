...
/// <summary>
/// PTS_YM_TFM_002_240 - TF_M su YM a 4 ore, <b>S46</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S46.</b> E' l'identificativo con cui questa strategia compare
...
/// <list type="bullet">
/// <item><description>deve essere VERO - neutrale <c>32</c></description></item>
...
/// <list type="bullet">
/// <item><description>Stop loss: <b>$4.000</b> per contratto = <b>800.00 pt</b></description></item>
/// <item><description>Take profit: <b>$1.500</b> = <b>300.00 pt</b></description></item>
...
/// <item><term>Fuori campione</term><description>$77.981 su 141 trade</description></item>
/// <item><term>Drawdown</term><description>$15.059</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260824_1550/consegna/trades/fam02_TF_M.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_YM_TFM_002_240 : TfMirroredEngine
{
    public override string Name => "PTS_YM_TFM_002_240";
    public override string Description =>
        "TF_M YM 4 ore: S46 del dossier, run run_20260824_1550, finestra 06:00-23:59 CET, multiday";
    public override string Symbol => "@YM";
    public override int TimeframeMinutes => 240;

    public PTS_YM_TFM_002_240()
    {
        ...
        StopMoney = 4000;        // stop_loss, $ per contratto = 800.00 pt
        ProfitMoney = 1500;      // take_profit, $ per contratto = 300.00 pt
