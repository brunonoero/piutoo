...
/// <summary>
/// PTS_FDAX_SBO_001_240 - BO su FDAX a 4 ore, <b>S19</b> del dossier
...
/// <list type="bullet">
/// <item><description>deve essere VERO - neutrale <c>15</c></description></item>
/// <item><description>deve essere FALSO - neutrale <c>30</c></description></item>
...
/// <list type="bullet">
/// <item><description>Opera solo fra <b>07:00 e 10:00</b>, ora della ricerca (CET)</description></item>
...
/// <item><description>Take profit: <b>$3.000</b> = <b>120.00 pt</b></description></item>
...
/// <item><term>Atteso per trade</term><description>$562</description></item>
/// <item><term>Fuori campione</term><description>$201.461 su 341 trade</description></item>
/// <item><term>Drawdown</term><description>$9.839</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260824_1500/consegna/trades/fam03_BO.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_FDAX_SBO_001_240 : SessionBreakoutEngine
{
    public override string Name => "PTS_FDAX_SBO_001_240";
    public override string Description =>
        "BO FDAX 4 ore: S19 del dossier, run run_20260824_1500, finestra 07:00-10:00 CET, multiday";
    ...
    public PTS_FDAX_SBO_001_240()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(7, 10);   // start_hour 7, end_hour 10
        ...
        ProfitMoney = 3000;      // take_profit, $ per contratto = 120.00 pt
