...
/// <summary>
/// PTS_NQ_TFM_012_1440 - TF_M su NQ a giornaliero, <b>S01</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S01.</b> E' l'identificativo con cui questa strategia compare
...
/// <item><term>Atteso per trade</term><description>$3.809</description></item>
/// <item><term>Fuori campione</term><description>$121.877 su 32 trade</description></item>
/// <item><term>Drawdown</term><description>$18.840</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260822_0736/consegna/trades/fam01_TF_M.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_NQ_TFM_012_1440 : TfMirroredEngine
{
    public override string Name => "PTS_NQ_TFM_012_1440";
    public override string Description =>
        "TF_M NQ giornaliero: S01 del dossier, run run_20260822_0736, finestra 24h, multiday";
    public override string Symbol => "@NQ";
    public override int TimeframeMinutes => 1440;

    public PTS_NQ_TFM_012_1440()
    {
