...
/// <summary>
/// PTS_NQ_TFM_008_30 — TF_M su NQ a 30 minuti, famiglia 03 della consegna
/// <c>run_20260815_1021</c>.
///
/// <para><b>Codice sorgente: S24.</b> E' l'identificativo con cui questa strategia
...
/// <c>run_20260815_1021/consegna/trades/fam03_TF_M.csv</c>.</para>
///
...
/// <item><description>deve essere FALSO — direzionale -36: <c>(H_d1 &lt; H_d2) E (H_d1 &lt; H_d3) E (H_d1 &lt; H_d4)</c></description></item>
/// </list>
/// <para><b>Solo SHORT</b></para>
/// <list type="bullet">
/// <item><description>deve essere VERO — direzionale 50: <c>close &lt; O_d0 * 0.995</c></description></item>
/// <item><description>deve essere FALSO — direzionale -36: <c>(L_d1 &gt; L_d2) E (L_d1 &gt; L_d3) E (L_d1 &gt; L_d4)</c></description></item>
/// </list>
///
/// <para><b>Quando può operare.</b></para>
/// <list type="bullet">
/// <item><description>Opera solo fra 09:00 e 19:00, ora dei dati (CET)</description></item>
...
/// <item><description>Uscita a tempo dopo 12 barre (6 ore)</description></item>
/// </list>
///
...
/// <item><term>Atteso per trade</term><description>$335.2</description></item>
/// <item><term>Out-of-sample</term><description>$57,321 su 171 trade &#183; drawdown $6,123 &#183; profit factor 2.63 &#183; $335 per trade.</description></item>
/// <item><term>Plateau minimo</term><description>0.74</description></item>
/// <item><term>Efficienza Walk-Forward</term><description>1.0</description></item>
/// <item><term>Monte Carlo drawdown p95</term><description>$7,570</description></item>
/// </list>
/// </summary>
public sealed class PTS_NQ_TFM_008_30 : TfMirroredEngine
{
    public override string Name => "PTS_NQ_TFM_008_30";
    public override string Description =>
        "TF_M NQ 30m: famiglia 03 run 20260815, finestra 09:00–19:00 CET, multiday";
    public override string Symbol => "@NQ";
    public override int TimeframeMinutes => 30;

    public PTS_NQ_TFM_008_30()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(9, 19);
        ...
        DirectionalNo = -36; // ptn_dir_no, specchiato dal motore
