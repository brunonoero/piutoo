...
/// <summary>
/// PTS_JY_TFU_004_30 - TF_U su JY a 30 minuti, <b>S39</b> del dossier
/// <c>run-engine/run-08-settembre/DOSSIER_PANIERE (1).md</c>.
///
/// <para><b>Codice sorgente: S39.</b> E' l'identificativo con cui questa strategia compare
...
/// <item><description>LONG deve essere FALSO - fast <c>115</c>: <c>C_d1 - L_d1 &lt; 0.2 * (H_d1-L_d1)</c></description></item>
...
/// <list type="bullet">
/// <item><description>Opera solo fra <b>13:00 e 08:00</b>, ora della ricerca (CET): la finestra attraversa la mezzanotte</description></item>
...
/// <item><term>Atteso per trade</term><description>$309</description></item>
/// <item><term>Fuori campione</term><description>$31.279 su 68 trade</description></item>
/// <item><term>Drawdown</term><description>$7.005</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>JY_30m/consegna/trades/fam02_TF_U.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
public sealed class PTS_JY_TFU_004_30 : TfUnmirroredEngine
{
    public override string Name => "PTS_JY_TFU_004_30";
    public override string Description =>
        "TF_U JY 30m: S39 del dossier, run JY_30m, finestra 13:00-08:00 CET, multiday";
    public override string Symbol => "@JY";
    public override int TimeframeMinutes => 30;

    public PTS_JY_TFU_004_30()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(13, 8);   // start_hour 13, end_hour 8, a cavallo della mezzanotte
