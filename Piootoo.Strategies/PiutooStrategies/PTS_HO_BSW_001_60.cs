...
/// <summary>
/// PTS_HO_BSW_001_60 - BIASW su HO a 60 minuti, <b>S33</b> del dossier
/// <c>run-engine/run-08-settembre/DOSSIER_PANIERE (1).md</c>.
///
/// <para><b>Codice sorgente: S33.</b> E' l'identificativo con cui questa strategia compare
...
/// <c>fam01</c>, motore <c>BIASW</c>.</para>
///
...
/// <item><description>SHORT: MARKET all'apertura della barra delle <b>01:00 di lunedi'</b></description></item>
...
/// <item><description>SHORT deve essere VERO - fast <c>6</c>: <c>|O_d1-C_d1| &gt; 0.5 * (H_d1-L_d1)</c></description></item>
/// <item><description>SHORT deve essere FALSO - fast <c>32</c>: <c>H_d0 - O_d0 &gt; (H_d1 - O_d1) * 0.5</c></description></item>
/// </list>
///
/// <para><b>Uscite.</b> Sono autocontenute nel segnale di ingresso e vengono applicate
/// dall'engine o dal broker: la strategia non emette mai segnali di chiusura.</para>
/// <list type="bullet">
/// <item><description>Uscita LONG programmata: <b>venerdi' alle 02:00</b>, market all'apertura di quella barra. E' l'uscita principale: stop e target agiscono solo se scattano prima.</description></item>
...
/// <item><term>Atteso per trade</term><description>$384</description></item>
/// <item><term>Fuori campione</term><description>$54.711 su 58 trade</description></item>
/// <item><term>Drawdown</term><description>$9.213</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>HO_1h/consegna/trades/fam01_BIASW.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_HO_BSW_001_60 : BiasWeeklyEngine
{
    public override string Name => "PTS_HO_BSW_001_60";
    public override string Description =>
        "BIASW HO 60m: S33 del dossier, run HO_1h, long martedi' 23:00 -> venerdi' 02:00 CET, multiday";
    ...
    public PTS_HO_BSW_001_60()
    {
        ...
        EntryDayLong = 1;      // le_day: 1 = martedi' (convenzione pandas, 0 = lunedi')
        ...
        EntryTimeShort = 100;  // se_time: 01:00
        ...
        FastYesShort = 6;     // ptn_sy_yes: |O_d1-C_d1| > 0.5 * (H_d1-L_d1)
        FastNoShort = 32;     // ptn_sy_no:  H_d0 - O_d0 > (H_d1 - O_d1) * 0.5

        StopMoneyLong = 1250m;    // stop_loss, $ per contratto = 0,03 pt
        ProfitMoneyLong = 5000m;  // take_profit, $ per contratto = 0,12 pt
        StopMoneyShort = 1250m;
        ProfitMoneyShort = 5000m;
