...
/// <summary>
/// PTS_NG_TFM_003_30 - TF_M su NG a 30 minuti, <b>S59</b> del dossier
...
/// <list type="bullet">
/// <item><description>deve essere VERO - neutrale <c>4</c>: <c>|O_d1-C_d1| &lt; 0.75 * (H_d1-L_d1)</c></description></item>
/// <item><description>deve essere FALSO - neutrale <c>33</c>: <c>(H_d0-L_d0) &gt; L_d0 * 0.01</c></description></item>
...
/// <list type="bullet">
/// <item><description>Opera solo fra <b>22:00 e 17:00</b>, ora della ricerca (CET): la finestra attraversa la mezzanotte</description></item>
...
/// <list type="bullet">
/// <item><description>Stop loss: <b>$750</b> per contratto = <b>0,07 pt</b></description></item>
...
/// <item><term>Atteso per trade</term><description>$200</description></item>
/// <item><term>Fuori campione</term><description>$44.814 su 196 trade</description></item>
/// <item><term>Drawdown</term><description>$14.670</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>NG_30m/consegna/trades/fam01_TF_M.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_NG_TFM_003_30 : TfMirroredEngine
{
    public override string Name => "PTS_NG_TFM_003_30";
    public override string Description =>
        "TF_M NG 30m: S59 del dossier, run NG_30m, finestra 22:00-17:00 CET, multiday";
    public override string Symbol => "@NG";
    public override int TimeframeMinutes => 30;

    public PTS_NG_TFM_003_30()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(22, 17);   // start_hour 22, end_hour 17, a cavallo della mezzanotte
        ...
        DirectionalNo = -37;  // ptn_dir_no (il segno lo applica il motore per verso)
        SkipDay = -1;         // skip_day (convenzione pandas, 0 = lunedi')

        IntradayOnly = false;    // intraday_only = 0

        StopMoney = 750;         // stop_loss, $ per contratto = 0,07 pt
