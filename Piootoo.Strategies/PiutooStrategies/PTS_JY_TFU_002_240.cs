...
/// <summary>
/// PTS_JY_TFU_002_240 - TF_U su JY a 4 ore, <b>S63</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S63.</b> E' l'identificativo con cui questa strategia compare
/// nel dossier: e' da li' che si risale a condizioni, filtri e parametri per un controllo,
/// senza riaprire i CSV a tentativi. La riga di ricerca e' <c>run_20260824_2020</c>, famiglia
...
/// <list type="bullet">
/// <item><description>LONG deve essere VERO - fast <c>82</c></description></item>
/// <item><description>LONG deve essere FALSO - fast <c>100</c></description></item>
/// <item><description>SHORT deve essere VERO - fast <c>152</c> <i>(sentinella: nessun filtro)</i></description></item>
/// <item><description>SHORT deve essere FALSO - fast <c>115</c></description></item>
/// </list>
///
...
/// <item><term>Atteso per trade</term><description>$98</description></item>
/// <item><term>Fuori campione</term><description>$36.111 su 79 trade</description></item>
/// <item><term>Drawdown</term><description>$9.809</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260824_2020/consegna/trades/fam02_TF_U.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
[StrategiaDisabilitata(
    "Nessuna InstrumentSpec verificata per JY: vedi PTS_JY_TFU_001_240.")]
public sealed class PTS_JY_TFU_002_240 : TfUnmirroredEngine
{
    public override string Name => "PTS_JY_TFU_002_240";
    public override string Description =>
        "TF_U JY 4 ore: S63 del dossier, run run_20260824_2020, finestra 24h, multiday";
    public override string Symbol => "@JY";
    public override int TimeframeMinutes => 240;

    public PTS_JY_TFU_002_240()
    {
        ...
        FastYesLong = 82;     // ptn_fast_yes_long
        FastNoLong = 100;      // ptn_fast_no_long
        FastYesShort = 152;    // ptn_fast_yes_short
        FastNoShort = 115;     // ptn_fast_no_short
