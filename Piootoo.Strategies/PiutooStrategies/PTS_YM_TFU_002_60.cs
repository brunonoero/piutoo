...
/// <summary>
/// PTS_YM_TFU_002_60 - TF_U su YM a 60 minuti, <b>S83</b> del dossier
/// <c>run-engine/run-08-settembre/DOSSIER_PANIERE (1).md</c>.
///
/// <para><b>Codice sorgente: S83.</b> E' l'identificativo con cui questa strategia compare
...
/// essere FALSO". Qui i due gate positivi hanno lo <b>stesso</b> numero: il motore TF_U li
/// valuta comunque separatamente, ed e' cio' che rende asimmetrica la strategia il gate
/// negativo, non quello positivo.</para>
/// <list type="bullet">
/// <item><description>LONG deve essere VERO - fast <c>136</c>: <c>(C_d1 &gt; O_d1) E (C_d2 &gt; O_d2)</c></description></item>
/// <item><description>LONG deve essere FALSO - fast <c>78</c>: <c>C_d1 &gt; C_d2 * (1 + 0.01)</c></description></item>
/// <item><description>SHORT deve essere VERO - fast <c>136</c>: <c>(C_d1 &gt; O_d1) E (C_d2 &gt; O_d2)</c></description></item>
/// <item><description>SHORT deve essere FALSO - fast <c>53</c>: <c>H_d0 &gt; L_d0 * (1 + 0.005)</c></description></item>
/// </list>
///
/// <para><b>Quando puo' operare.</b></para>
/// <list type="bullet">
/// <item><description>Opera solo fra <b>12:00 e 03:00</b>, ora della ricerca (CET): la finestra attraversa la mezzanotte</description></item>
...
/// <list type="bullet">
/// <item><description>Stop loss: <b>$1.000</b> per contratto = <b>200,00 pt</b></description></item>
...
/// <item><term>Atteso per trade</term><description>$120</description></item>
/// <item><term>Fuori campione</term><description>$49.462 su 97 trade</description></item>
/// <item><term>Drawdown</term><description>$13.246</description></item>
/// </list>
///
...
/// lista di <c>PTS_YM_TFU_003_60</c> (S105): sono due varianti della stessa famiglia, con
/// uscite diverse.</para>
/// </summary>
public sealed class PTS_YM_TFU_002_60 : TfUnmirroredEngine
{
    public override string Name => "PTS_YM_TFU_002_60";
    public override string Description =>
        "TF_U YM 60m: S83 del dossier, run YM_1h, finestra 12:00-03:00 CET, multiday";
    public override string Symbol => "@YM";
    public override int TimeframeMinutes => 60;

    public PTS_YM_TFU_002_60()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(12, 3);   // start_hour 12, end_hour 3, a cavallo della mezzanotte

        FastYesLong = 136;     // ptn_fast_yes_long
        FastNoLong = 78;       // ptn_fast_no_long
        ...
        StopMoney = 1000;        // stop_loss, $ per contratto = 200,00 pt
