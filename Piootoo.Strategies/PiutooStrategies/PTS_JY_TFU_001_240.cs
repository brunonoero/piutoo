...
/// <summary>
/// PTS_JY_TFU_001_240 - TF_U su JY a 4 ore, <b>S56</b> del dossier
...
/// <list type="bullet">
/// <item><description>LONG deve essere VERO - fast <c>152</c> <i>(sentinella: nessun filtro)</i></description></item>
/// <item><description>LONG deve essere FALSO - fast <c>100</c></description></item>
/// <item><description>SHORT deve essere VERO - fast <c>132</c></description></item>
...
/// <item><term>Fuori campione</term><description>$36.246 su 67 trade</description></item>
/// <item><term>Drawdown</term><description>$11.957</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260824_2020/consegna/trades/fam01_TF_U.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
public sealed class PTS_JY_TFU_001_240 : TfUnmirroredEngine
{
    public override string Name => "PTS_JY_TFU_001_240";
    public override string Description =>
        "TF_U JY 4 ore: S56 del dossier, run run_20260824_2020, finestra 24h, multiday";
    public override string Symbol => "@JY";
    public override int TimeframeMinutes => 240;

    public PTS_JY_TFU_001_240()
    {
        ...
        FastYesLong = 152;     // ptn_fast_yes_long
        FastNoLong = 100;      // ptn_fast_no_long
        FastYesShort = 132;    // ptn_fast_yes_short
