...
/// <summary>
/// PTS_BP_TFM_001_60 - TF_M su BP a 60 minuti, <b>S27</b> del dossier
/// <c>run-engine/run-07-agosto/DOSSIER_PANIERE.md</c>.
///
/// <para><b>Codice sorgente: S27.</b> E' l'identificativo con cui questa strategia compare
/// nel dossier: e' da li' che si risale a condizioni, filtri e parametri per un controllo,
/// senza riaprire i CSV a tentativi. La riga di ricerca e' <c>run_20260823_1535</c>, famiglia
...
/// <list type="bullet">
/// <item><description>deve essere VERO - neutrale <c>23</c></description></item>
/// <item><description>deve essere FALSO - neutrale <c>47</c></description></item>
...
/// <list type="bullet">
/// <item><description>Opera solo fra <b>20:00 e 19:00</b> (a cavallo della mezzanotte), ora della ricerca (CET)</description></item>
...
/// <item><description>Take profit: <b>$2.000</b> = <b>0.03 pt</b></description></item>
...
/// <item><term>Atteso per trade</term><description>$303</description></item>
/// <item><term>Fuori campione</term><description>$15.958 su 26 trade</description></item>
/// <item><term>Drawdown</term><description>$3.880</description></item>
/// </list>
///
/// <para><b>Verifica del porting.</b> Lista trade di riferimento:
/// <c>run_20260823_1535/consegna/trades/fam01_TF_M.csv</c>. Contano le <b>entrate</b>: timestamp e prezzo.
...
/// </summary>
public sealed class PTS_BP_TFM_001_60 : TfMirroredEngine
{
    public override string Name => "PTS_BP_TFM_001_60";
    public override string Description =>
        "TF_M BP 60 minuti: S27 del dossier, run run_20260823_1535, finestra 20:00-19:00 CET, multiday";
    public override string Symbol => "@BP";
    public override int TimeframeMinutes => 60;

    public PTS_BP_TFM_001_60()
    {
        ...
        TradingWindow = ZonedWindow.ResearchHours(20, 19);   // start_hour 20, end_hour 19

        NeutralYes = 23;      // ptn_neut_yes
        NeutralNo = 47;       // ptn_neut_no
        ...
        ProfitMoney = 2000;      // take_profit, $ per contratto = 0.03 pt
